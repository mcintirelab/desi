---
title: "AGE positive batch correction and stats striatum whole brain ions"
...
```{r}
percentage_of_ion_intensities_roi_191_a3_WT_s4_striatum_df <- read.csv('D:/All AGE Positive masks and roi sums/Average Striatum/191_a3_WT_s4_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_191_a3_WT_s4_striatum_df)[1] = "191_a3_WT_s4"
# Make row names into column
percentage_of_ion_intensities_roi_191_a3_WT_s4_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_191_a3_WT_s4_striatum_df)

percentage_of_ion_intensities_roi_226_a1_Tg_s3_striatum_df <- read.csv('D:/All AGE Positive masks and roi sums/Average Striatum/226_a1_Tg_s3_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_226_a1_Tg_s3_striatum_df)[1] = "226_a1_Tg_s3"
# Make row names into column
percentage_of_ion_intensities_roi_226_a1_Tg_s3_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_226_a1_Tg_s3_striatum_df)

percentage_of_ion_intensities_roi_225_a1wt_striatum_df <- read.csv('D:/All AGE Positive masks and roi sums/Average Striatum/225_a1wt_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
...
percentage_of_ion_intensities_roi_208_5wt_striatum_df <- read.csv('D:/All AGE Positive masks and roi sums/Average Striatum/208_5wt_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
...
percentage_of_ion_intensities_roi_209_2wt_striatum_df <- read.csv('D:/All AGE Positive masks and roi sums/Average Striatum/209_2wt_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
...
percentage_of_ion_intensities_roi_226_a2_WT_s4_striatum_df <- read.csv('D:/All AGE Positive masks and roi sums/Average Striatum/226_a2_WT_s4_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_226_a2_WT_s4_striatum_df)[1] = "226_a2_WT_s4"
# Make row names into column
percentage_of_ion_intensities_roi_226_a2_WT_s4_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_226_a2_WT_s4_striatum_df)

percentage_of_ion_intensities_roi_249_4_Tg_s3_striatum_df <- read.csv('D:/All AGE Positive masks and roi sums/Average Striatum/249_4_Tg_s3_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_249_4_Tg_s3_striatum_df)[1] = "249_4_Tg_s3"
# Make row names into column
percentage_of_ion_intensities_roi_249_4_Tg_s3_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_249_4_Tg_s3_striatum_df)

percentage_of_ion_intensities_roi_256_2_WT_s4_striatum_df <- read.csv('D:/All AGE Positive masks and roi sums/Average Striatum/256_2_WT_s4_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_256_2_WT_s4_striatum_df)[1] = "256_2_WT_s4"
# Make row names into column
percentage_of_ion_intensities_roi_256_2_WT_s4_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_256_2_WT_s4_striatum_df)

percentage_of_ion_intensities_roi_256_a3_Tg_s3_striatum_df <- read.csv('D:/All AGE Positive masks and roi sums/Average Striatum/256_a3_Tg_s3_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_256_a3_Tg_s3_striatum_df)[1] = "256_a3_Tg_s3"
# Make row names into column
percentage_of_ion_intensities_roi_256_a3_Tg_s3_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_256_a3_Tg_s3_striatum_df)

percentage_of_ion_intensities_roi_268_3_Tg_s5_striatum_df <- read.csv('D:/All AGE Positive masks and roi sums/Average Striatum/268_3_Tg_s5_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_268_3_Tg_s5_striatum_df)[1] = "268_3_Tg_s5"
# Make row names into column
percentage_of_ion_intensities_roi_268_3_Tg_s5_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_268_3_Tg_s5_striatum_df)

percentage_of_ion_intensities_roi_268_a3_WT_s3_striatum_df <- read.csv('D:/All AGE Positive masks and roi sums/Average Striatum/268_a3_WT_s3_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_268_a3_WT_s3_striatum_df)[1] = "268_a3_WT_s3"
# Make row names into column
percentage_of_ion_intensities_roi_268_a3_WT_s3_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_268_a3_WT_s3_striatum_df)

percentage_of_ion_intensities_roi_225_3tg_striatum_df <- read.csv('D:/All AGE Positive masks and roi sums/Average Striatum/225_3tg_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
...
percentage_of_ion_intensities_roi_270_5_Tg_s5_striatum_df <- read.csv('D:/All AGE Positive masks and roi sums/Average Striatum/270_5_Tg_s5_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_270_5_Tg_s5_striatum_df)[1] = "270_5_Tg_s5"
# Make row names into column
percentage_of_ion_intensities_roi_270_5_Tg_s5_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_270_5_Tg_s5_striatum_df)

percentage_of_ion_intensities_roi_271_a3_Tg_s3_striatum_df <- read.csv('D:/All AGE Positive masks and roi sums/Average Striatum/271_a3_Tg_s3_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_271_a3_Tg_s3_striatum_df)[1] = "271_a3_Tg_s3"
# Make row names into column
percentage_of_ion_intensities_roi_271_a3_Tg_s3_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_271_a3_Tg_s3_striatum_df)

percentage_of_ion_intensities_roi_210_a1tg_striatum_df <- read.csv('D:/All AGE Positive masks and roi sums/Average Striatum/210_a1tg_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
...
percentage_of_ion_intensities_roi_278_a2_WT_s2_striatum_df <- read.csv('D:/All AGE Positive masks and roi sums/Average Striatum/278_a2_WT_s2_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_278_a2_WT_s2_striatum_df)[1] = "278_a2_WT_s2"
# Make row names into column
percentage_of_ion_intensities_roi_278_a2_WT_s2_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_278_a2_WT_s2_striatum_df)

percentage_of_ion_intensities_roi_308_3_Tg_s5_striatum_df <- read.csv('D:/All AGE Positive masks and roi sums/Average Striatum/308_3_Tg_s5_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_308_3_Tg_s5_striatum_df)[1] = "308_3_Tg_s5"
# Make row names into column
percentage_of_ion_intensities_roi_308_3_Tg_s5_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_308_3_Tg_s5_striatum_df)

percentage_of_ion_intensities_roi_308_4_WT_s2_striatum_df <- read.csv('D:/All AGE Positive masks and roi sums/Average Striatum/308_4_WT_s2_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_308_4_WT_s2_striatum_df)[1] = "308_4_WT_s2"
# Make row names into column
percentage_of_ion_intensities_roi_308_4_WT_s2_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_308_4_WT_s2_striatum_df)
```

Below we combine all the normalized percentage.

```{r}
dfs_to_merge <- list(percentage_of_ion_intensities_roi_191_a3_WT_s4_striatum_df, percentage_of_ion_intensities_roi_226_a1_Tg_s3_striatum_df, percentage_of_ion_intensities_roi_225_a1wt_striatum_df, percentage_of_ion_intensities_roi_208_5wt_striatum_df, percentage_of_ion_intensities_roi_209_2wt_striatum_df, percentage_of_ion_intensities_roi_226_a2_WT_s4_striatum_df, percentage_of_ion_intensities_roi_249_4_Tg_s3_striatum_df, percentage_of_ion_intensities_roi_256_2_WT_s4_striatum_df, percentage_of_ion_intensities_roi_256_a3_Tg_s3_striatum_df, percentage_of_ion_intensities_roi_268_3_Tg_s5_striatum_df, percentage_of_ion_intensities_roi_268_a3_WT_s3_striatum_df, percentage_of_ion_intensities_roi_225_3tg_striatum_df, percentage_of_ion_intensities_roi_270_5_Tg_s5_striatum_df, percentage_of_ion_intensities_roi_271_a3_Tg_s3_striatum_df, percentage_of_ion_intensities_roi_210_a1tg_striatum_df, percentage_of_ion_intensities_roi_278_a2_WT_s2_striatum_df, percentage_of_ion_intensities_roi_308_3_Tg_s5_striatum_df, percentage_of_ion_intensities_roi_308_4_WT_s2_striatum_df)
# Merge all into one
...
write.csv(assay_not_standardized, "D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/AGE_positive_striatum_combat_batch_corrected_percentages.csv")
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots/6mo_vs_12mo_vs_22mo_significant_all_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots/wt_vs_tg_significant_6mo_ion_",ion,".png"))
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots/wt_vs_tg_significant_with_correction_6mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo[, ion] ~ treatment_final_6mo, main="Ion distribution WT vs Tg 6mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots/wt_vs_tg_significant_12mo_ion_",ion,".png"))
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots/wt_vs_tg_significant_with_correction_12mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo[, ion] ~ treatment_final_12mo, main="Ion distribution WT vs Tg 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots/wt_vs_tg_significant_22mo_ion_",ion,".png"))
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots/wt_vs_tg_significant_with_correction_22mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_22mo[, ion] ~ treatment_final_22mo, main="Ion distribution WT vs Tg 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots/6mo_vs_12mo_vs_22mo_significant_wt_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots/6mo_vs_12mo_vs_22mo_significant_with_correction_wt_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots/6mo_vs_12mo_vs_22mo_significant_tg_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots/6mo_vs_12mo_vs_22mo_significant_with_correction_tg_ANOVA_ion_",ion,".png"))
...
write.csv(final_aov_dataframe_with_correction_anova_all, 'D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Average Striatum Statistical Testing Results Normalized By Pixel/AGE_striatum_all_samples_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_6mo_after_anova, 'D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Average Striatum Statistical Testing Results Normalized By Pixel/AGE_6mo_striatum_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_12mo_after_anova, 'D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Average Striatum Statistical Testing Results Normalized By Pixel/AGE_12mo_striatum_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_22mo_after_anova, 'D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Average Striatum Statistical Testing Results Normalized By Pixel/AGE_22mo_striatum_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_wt_after_anova, 'D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Average Striatum Statistical Testing Results Normalized By Pixel/AGE_striatum_wt_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_tg_after_anova, 'D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Average Striatum Statistical Testing Results Normalized By Pixel/AGE_striatum_tg_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
```
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots Within Phenotype Testing/6mo_vs_12mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots Within Phenotype Testing/6mo_vs_12mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_12mo_wt[, ion] ~ factor(treatment_final_wt_6mo_12mo, levels = c('6mo', '12mo')), main="Ion distribution wt 6mo vs 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots Within Phenotype Testing/6mo_vs_22mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots Within Phenotype Testing/6mo_vs_22mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_22mo_wt[, ion] ~ factor(treatment_final_wt_6mo_22mo, levels = c('6mo', '22mo')), main="Ion distribution wt 6mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots Within Phenotype Testing/12mo_vs_22mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots Within Phenotype Testing/12mo_vs_22mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo_22mo_wt[, ion] ~ factor(treatment_final_wt_12mo_22mo, levels = c('12mo', '22mo')), main="Ion distribution wt 12mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots Within Phenotype Testing/6mo_vs_12mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots Within Phenotype Testing/6mo_vs_12mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_12mo_tg[, ion] ~ factor(treatment_final_tg_6mo_12mo, levels = c('6mo', '12mo')), main="Ion distribution tg 6mo vs 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots Within Phenotype Testing/6mo_vs_22mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots Within Phenotype Testing/6mo_vs_22mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_22mo_tg[, ion] ~ factor(treatment_final_tg_6mo_22mo, levels = c('6mo', '22mo')), main="Ion distribution tg 6mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots Within Phenotype Testing/12mo_vs_22mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots Within Phenotype Testing/12mo_vs_22mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo_22mo_tg[, ion] ~ factor(treatment_final_tg_12mo_22mo, levels = c('12mo', '22mo')), main="Ion distribution tg 12mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_12mo_wt_after_anova, 'D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Average Striatum Statistical Testing Results Within Phenotype Testing/AGE_positive_striatum_6mo_vs_12mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_22mo_wt_after_anova, 'D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Average Striatum Statistical Testing Results Within Phenotype Testing/AGE_positive_striatum_6mo_vs_22mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_12mo_22mo_wt_after_anova, 'D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Average Striatum Statistical Testing Results Within Phenotype Testing/AGE_positive_striatum_12mo_vs_22mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_12mo_tg_after_anova, 'D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Average Striatum Statistical Testing Results Within Phenotype Testing/AGE_positive_striatum_6mo_vs_12mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_22mo_tg_after_anova, 'D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Average Striatum Statistical Testing Results Within Phenotype Testing/AGE_positive_striatum_6mo_vs_22mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_12mo_22mo_tg_after_anova, 'D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Average Striatum Statistical Testing Results Within Phenotype Testing/AGE_positive_striatum_12mo_vs_22mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
```
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots Mol Percentage/all_groups_significant_anova_ion_",ion,".png"))
...
png(filename=paste("D:/All AGE Positive masks and roi sums/Average Striatum/Whole Brain Ions/Boxplots Mol Percentage/all_groups_significant_with_correction_anova_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_anova_all_not_standardized[, ion] ~ factor(treatment_final_all, levels = c('wt_6mo', 'wt_12mo', 'wt_22mo', 'tg_6mo', 'tg_12mo', 'tg_22mo')), main="Ion distribution All Groups ANOVA",
   xlab=paste("Ion m/z value", ion), ylab="Mol % Within Brain")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
