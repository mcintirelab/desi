---
title: "NEW Age Negative batch correction and stats thalamus"
...
```{r}
percentage_of_ion_intensities_roi_226_a2_wt_thalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Thalamus/226_a2_wt_s2_percentage_of_ions_within_thalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_226_a2_wt_thalamus_df)[1] = "226_a2_wt"
# Make row names into column
percentage_of_ion_intensities_roi_226_a2_wt_thalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_226_a2_wt_thalamus_df)

percentage_of_ion_intensities_roi_225_4wt_thalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Thalamus/225_4wt_percentage_of_ions_within_thalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_4wt_thalamus_df)[1] = "225_4wt"
# Make row names into column
percentage_of_ion_intensities_roi_225_4wt_thalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_225_4wt_thalamus_df)

percentage_of_ion_intensities_roi_225_a1wt_thalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Thalamus/225_a1wt_percentage_of_ions_within_thalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_a1wt_thalamus_df)[1] = "225_a1wt"
# Make row names into column
percentage_of_ion_intensities_roi_225_a1wt_thalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_225_a1wt_thalamus_df)

percentage_of_ion_intensities_roi_208_5wt_thalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Thalamus/208_5wt_percentage_of_ions_within_thalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_208_5wt_thalamus_df)[1] = "208_5wt"
# Make row names into column
percentage_of_ion_intensities_roi_208_5wt_thalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_208_5wt_thalamus_df)

percentage_of_ion_intensities_roi_209_2wt_thalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Thalamus/209_2wt_percentage_of_ions_within_thalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_209_2wt_thalamus_df)[1] = "209_2wt"
# Make row names into column
percentage_of_ion_intensities_roi_209_2wt_thalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_209_2wt_thalamus_df)

percentage_of_ion_intensities_roi_278_a2_wt_thalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Thalamus/278_a2_wt_s1_percentage_of_ions_within_thalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_278_a2_wt_thalamus_df)[1] = "278_a2_wt"
# Make row names into column
percentage_of_ion_intensities_roi_278_a2_wt_thalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_278_a2_wt_thalamus_df)

percentage_of_ion_intensities_roi_191_a3wt_thalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Thalamus/191_a3wt_percentage_of_ions_within_thalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_191_a3wt_thalamus_df)[1] = "191_a3wt"
# Make row names into column
percentage_of_ion_intensities_roi_191_a3wt_thalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_191_a3wt_thalamus_df)

percentage_of_ion_intensities_roi_252_8_wt_thalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Thalamus/252_8_wt_s1_percentage_of_ions_within_thalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_252_8_wt_thalamus_df)[1] = "252_8_wt"
# Make row names into column
percentage_of_ion_intensities_roi_252_8_wt_thalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_252_8_wt_thalamus_df)

percentage_of_ion_intensities_roi_268_a3_wt_thalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Thalamus/268_a3_wt_s2_percentage_of_ions_within_thalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_268_a3_wt_thalamus_df)[1] = "268_a3_wt"
# Make row names into column
percentage_of_ion_intensities_roi_268_a3_wt_thalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_268_a3_wt_thalamus_df)

percentage_of_ion_intensities_roi_225_a2tg_thalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Thalamus/225_a2tg_percentage_of_ions_within_thalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_a2tg_thalamus_df)[1] = "225_a2tg"
# Make row names into column
percentage_of_ion_intensities_roi_225_a2tg_thalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_225_a2tg_thalamus_df)

percentage_of_ion_intensities_roi_270_5_Tg_thalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Thalamus/270_5_Tg_s4_percentage_of_ions_within_thalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_270_5_Tg_thalamus_df)[1] = "270_5_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_270_5_Tg_thalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_270_5_Tg_thalamus_df)

percentage_of_ion_intensities_roi_225_3tg_thalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Thalamus/225_3tg_percentage_of_ions_within_thalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_3tg_thalamus_df)[1] = "225_3tg"
# Make row names into column
percentage_of_ion_intensities_roi_225_3tg_thalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_225_3tg_thalamus_df)

percentage_of_ion_intensities_roi_270_a1_Tg_thalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Thalamus/270_a1_Tg_s1_percentage_of_ions_within_thalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_270_a1_Tg_thalamus_df)[1] = "270_a1_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_270_a1_Tg_thalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_270_a1_Tg_thalamus_df)

percentage_of_ion_intensities_roi_226_a1tg_thalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Thalamus/226_a1tg_percentage_of_ions_within_thalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_226_a1tg_thalamus_df)[1] = "226_a1tg"
# Make row names into column
percentage_of_ion_intensities_roi_226_a1tg_thalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_226_a1tg_thalamus_df)

percentage_of_ion_intensities_roi_210_a1tg_thalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Thalamus/210_a1tg_percentage_of_ions_within_thalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_210_a1tg_thalamus_df)[1] = "210_a1tg"
# Make row names into column
percentage_of_ion_intensities_roi_210_a1tg_thalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_210_a1tg_thalamus_df)

percentage_of_ion_intensities_roi_249_4_Tg_thalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Thalamus/249_4_Tg_s1_percentage_of_ions_within_thalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_249_4_Tg_thalamus_df)[1] = "249_4_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_249_4_Tg_thalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_249_4_Tg_thalamus_df)

percentage_of_ion_intensities_roi_256_a3_Tg_thalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Thalamus/256_a3_Tg_s1_percentage_of_ions_within_thalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_256_a3_Tg_thalamus_df)[1] = "256_a3_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_256_a3_Tg_thalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_256_a3_Tg_thalamus_df)

percentage_of_ion_intensities_roi_268_3_Tg_thalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Thalamus/268_3_Tg_s4_percentage_of_ions_within_thalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_268_3_Tg_thalamus_df)[1] = "268_3_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_268_3_Tg_thalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_268_3_Tg_thalamus_df)
```

Below we combine all the normalized percentage.

```{r}
dfs_to_merge <- list(percentage_of_ion_intensities_roi_226_a2_wt_thalamus_df, percentage_of_ion_intensities_roi_225_4wt_thalamus_df, percentage_of_ion_intensities_roi_225_a1wt_thalamus_df, percentage_of_ion_intensities_roi_208_5wt_thalamus_df, percentage_of_ion_intensities_roi_209_2wt_thalamus_df, percentage_of_ion_intensities_roi_278_a2_wt_thalamus_df, percentage_of_ion_intensities_roi_191_a3wt_thalamus_df, percentage_of_ion_intensities_roi_252_8_wt_thalamus_df, percentage_of_ion_intensities_roi_268_a3_wt_thalamus_df, percentage_of_ion_intensities_roi_225_a2tg_thalamus_df, percentage_of_ion_intensities_roi_270_5_Tg_thalamus_df, percentage_of_ion_intensities_roi_225_3tg_thalamus_df, percentage_of_ion_intensities_roi_270_a1_Tg_thalamus_df, percentage_of_ion_intensities_roi_226_a1tg_thalamus_df, percentage_of_ion_intensities_roi_210_a1tg_thalamus_df, percentage_of_ion_intensities_roi_249_4_Tg_thalamus_df, percentage_of_ion_intensities_roi_256_a3_Tg_thalamus_df, percentage_of_ion_intensities_roi_268_3_Tg_thalamus_df)
# Merge all into one
...
```{r}
processed_SE@metadata$results$`plots_pca.33ba5964-d242-4d9c-8808-3bfc89fb223f`

processed_SE@metadata$results$`plots_pca.c862e053-e875-41ee-b5c3-8927fc18ec1d`
```
...
```{r}
SE_batches_final_combat@metadata$results$`plots_pca.877bff69-8c59-4f69-9c00-ebea480f98d4`

SE_batches_final_combat@metadata$results$`plots_pca.a2e51722-17f2-4c2b-9c00-840f58734888`

SE_batches_final_combat@metadata$results$`plots_pca.6e5e8d82-7c68-4bcc-90bb-c375769275a6`
```
...
```{r}
SE_batches_final_median@metadata$results$`plots_pca.20ddb795-9a36-4e2d-a0d6-7976f39d318a`

SE_batches_final_median@metadata$results$`plots_pca.3d95de71-6ae9-4bf8-94e5-bd5fb6cf7a39`

SE_batches_final_median@metadata$results$`plots_pca.d78e75e3-0377-4e31-b269-212e1bb8be8b`
```
...
```{r}
processed_SE@metadata$results$`plots_pca.8f8f5207-2c4c-4556-ba71-e72f01c99b12`

processed_SE@metadata$results$`plots_pca.b30f3de7-512e-42ae-9105-d5cf83e0aaec`
```
...
write.csv(assay_not_standardized, "D:/NEW All AGE Negative masks and roi sums/Average Thalamus/AGE_negative_thalamus_combat_batch_corrected_percentages.csv")
...
```{r}
SE_batches_final_combat@metadata$results$`plots_pca.996b280b-6880-47ba-bc39-e994dc9e1885`

SE_batches_final_combat@metadata$results$`plots_pca.1079ed51-e8c2-4e9f-901a-49d1682f376e`

SE_batches_final_combat@metadata$results$`plots_pca.85f95913-b014-4a33-9aae-a8795af3651d`
```
...
#write.csv(median_batch_corrected_data_ions_of_interest, file = "D:/NEW All AGE Negative masks and roi sums/Average Thalamus/AGE_median_batch_corrected_sums_ions_of_interest.csv")
...
```{r}
SE_batches_final_median@metadata$results$`plots_pca.c1ca3103-ed50-4dc2-a0f0-f822e17869da`

SE_batches_final_median@metadata$results$`plots_pca.c17fd772-cbc6-4aa0-a9f1-07714fc5401b`

SE_batches_final_median@metadata$results$`plots_pca.74c3c1e3-91af-4786-a7a7-c2cf95104b23`
```
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots/6mo_vs_12mo_vs_22mo_significant_all_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots/wt_vs_tg_significant_6mo_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots/wt_vs_tg_significant_with_correction_6mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo[, ion] ~ treatment_final_6mo, main="Ion distribution WT vs Tg 6mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots/wt_vs_tg_significant_12mo_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots/wt_vs_tg_significant_with_correction_12mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo[, ion] ~ treatment_final_12mo, main="Ion distribution WT vs Tg 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots/wt_vs_tg_significant_22mo_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots/wt_vs_tg_significant_with_correction_22mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_22mo[, ion] ~ treatment_final_22mo, main="Ion distribution WT vs Tg 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots/6mo_vs_12mo_vs_22mo_significant_wt_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots/6mo_vs_12mo_vs_22mo_significant_with_correction_wt_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots/6mo_vs_12mo_vs_22mo_significant_tg_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots/6mo_vs_12mo_vs_22mo_significant_with_correction_tg_ANOVA_ion_",ion,".png"))
...
write.csv(final_aov_dataframe_with_correction_anova_all, 'D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Average Thalamus Statistical Testing Results Normalized By Pixel/AGE_thalamus_all_samples_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_6mo_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Average Thalamus Statistical Testing Results Normalized By Pixel/AGE_6mo_thalamus_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_12mo_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Average Thalamus Statistical Testing Results Normalized By Pixel/AGE_12mo_thalamus_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_22mo_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Average Thalamus Statistical Testing Results Normalized By Pixel/AGE_22mo_thalamus_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Average Thalamus Statistical Testing Results Normalized By Pixel/AGE_thalamus_wt_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Average Thalamus Statistical Testing Results Normalized By Pixel/AGE_thalamus_tg_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
```
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_12mo_wt[, ion] ~ factor(treatment_final_wt_6mo_12mo, levels = c('6mo', '12mo')), main="Ion distribution wt 6mo vs 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_22mo_wt[, ion] ~ factor(treatment_final_wt_6mo_22mo, levels = c('6mo', '22mo')), main="Ion distribution wt 6mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo_22mo_wt[, ion] ~ factor(treatment_final_wt_12mo_22mo, levels = c('12mo', '22mo')), main="Ion distribution wt 12mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_12mo_tg[, ion] ~ factor(treatment_final_tg_6mo_12mo, levels = c('6mo', '12mo')), main="Ion distribution tg 6mo vs 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_22mo_tg[, ion] ~ factor(treatment_final_tg_6mo_22mo, levels = c('6mo', '22mo')), main="Ion distribution tg 6mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo_22mo_tg[, ion] ~ factor(treatment_final_tg_12mo_22mo, levels = c('12mo', '22mo')), main="Ion distribution tg 12mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_12mo_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Average Thalamus Statistical Testing Results Within Phenotype Testing/AGE_negative_thalamus_6mo_vs_12mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_22mo_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Average Thalamus Statistical Testing Results Within Phenotype Testing/AGE_negative_thalamus_6mo_vs_22mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_12mo_22mo_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Average Thalamus Statistical Testing Results Within Phenotype Testing/AGE_negative_thalamus_12mo_vs_22mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_12mo_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Average Thalamus Statistical Testing Results Within Phenotype Testing/AGE_negative_thalamus_6mo_vs_12mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_22mo_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Average Thalamus Statistical Testing Results Within Phenotype Testing/AGE_negative_thalamus_6mo_vs_22mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_12mo_22mo_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Average Thalamus Statistical Testing Results Within Phenotype Testing/AGE_negative_thalamus_12mo_vs_22mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
```
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots For Paper/negative_thalamus_732_5503_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Thalamus/Boxplots For Paper/negative_thalamus_871_5392_boxplot.tiff", units="in", width=5, height=5, res=300)
