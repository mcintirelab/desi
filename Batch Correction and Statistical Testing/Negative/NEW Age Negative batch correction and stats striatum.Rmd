---
title: "NEW Age Negative batch correction and stats striatum"
...
```{r}
percentage_of_ion_intensities_roi_226_a2_wt_striatum_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Striatum/226_a2_wt_s2_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_226_a2_wt_striatum_df)[1] = "226_a2_wt"
# Make row names into column
percentage_of_ion_intensities_roi_226_a2_wt_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_226_a2_wt_striatum_df)

percentage_of_ion_intensities_roi_225_4wt_striatum_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Striatum/225_4wt_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_4wt_striatum_df)[1] = "225_4wt"
# Make row names into column
percentage_of_ion_intensities_roi_225_4wt_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_225_4wt_striatum_df)

percentage_of_ion_intensities_roi_225_a1wt_striatum_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Striatum/225_a1wt_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_a1wt_striatum_df)[1] = "225_a1wt"
# Make row names into column
percentage_of_ion_intensities_roi_225_a1wt_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_225_a1wt_striatum_df)

percentage_of_ion_intensities_roi_208_5wt_striatum_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Striatum/208_5wt_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_208_5wt_striatum_df)[1] = "208_5wt"
# Make row names into column
percentage_of_ion_intensities_roi_208_5wt_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_208_5wt_striatum_df)

percentage_of_ion_intensities_roi_209_2wt_striatum_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Striatum/209_2wt_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_209_2wt_striatum_df)[1] = "209_2wt"
# Make row names into column
percentage_of_ion_intensities_roi_209_2wt_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_209_2wt_striatum_df)

percentage_of_ion_intensities_roi_278_a2_wt_striatum_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Striatum/278_a2_wt_s1_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_278_a2_wt_striatum_df)[1] = "278_a2_wt"
# Make row names into column
percentage_of_ion_intensities_roi_278_a2_wt_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_278_a2_wt_striatum_df)

percentage_of_ion_intensities_roi_191_a3wt_striatum_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Striatum/191_a3wt_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_191_a3wt_striatum_df)[1] = "191_a3wt"
# Make row names into column
percentage_of_ion_intensities_roi_191_a3wt_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_191_a3wt_striatum_df)

percentage_of_ion_intensities_roi_252_8_wt_striatum_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Striatum/252_8_wt_s1_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_252_8_wt_striatum_df)[1] = "252_8_wt"
# Make row names into column
percentage_of_ion_intensities_roi_252_8_wt_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_252_8_wt_striatum_df)

percentage_of_ion_intensities_roi_268_a3_wt_striatum_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Striatum/268_a3_wt_s2_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_268_a3_wt_striatum_df)[1] = "268_a3_wt"
# Make row names into column
percentage_of_ion_intensities_roi_268_a3_wt_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_268_a3_wt_striatum_df)

percentage_of_ion_intensities_roi_225_a2tg_striatum_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Striatum/225_a2tg_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_a2tg_striatum_df)[1] = "225_a2tg"
# Make row names into column
percentage_of_ion_intensities_roi_225_a2tg_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_225_a2tg_striatum_df)

percentage_of_ion_intensities_roi_270_5_Tg_striatum_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Striatum/270_5_Tg_s4_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_270_5_Tg_striatum_df)[1] = "270_5_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_270_5_Tg_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_270_5_Tg_striatum_df)

percentage_of_ion_intensities_roi_225_3tg_striatum_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Striatum/225_3tg_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_3tg_striatum_df)[1] = "225_3tg"
# Make row names into column
percentage_of_ion_intensities_roi_225_3tg_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_225_3tg_striatum_df)

percentage_of_ion_intensities_roi_270_a1_Tg_striatum_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Striatum/270_a1_Tg_s1_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_270_a1_Tg_striatum_df)[1] = "270_a1_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_270_a1_Tg_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_270_a1_Tg_striatum_df)

percentage_of_ion_intensities_roi_226_a1tg_striatum_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Striatum/226_a1tg_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_226_a1tg_striatum_df)[1] = "226_a1tg"
# Make row names into column
percentage_of_ion_intensities_roi_226_a1tg_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_226_a1tg_striatum_df)

percentage_of_ion_intensities_roi_210_a1tg_striatum_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Striatum/210_a1tg_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_210_a1tg_striatum_df)[1] = "210_a1tg"
# Make row names into column
percentage_of_ion_intensities_roi_210_a1tg_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_210_a1tg_striatum_df)

percentage_of_ion_intensities_roi_249_4_Tg_striatum_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Striatum/249_4_Tg_s1_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_249_4_Tg_striatum_df)[1] = "249_4_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_249_4_Tg_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_249_4_Tg_striatum_df)

percentage_of_ion_intensities_roi_256_a3_Tg_striatum_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Striatum/256_a3_Tg_s1_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_256_a3_Tg_striatum_df)[1] = "256_a3_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_256_a3_Tg_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_256_a3_Tg_striatum_df)

percentage_of_ion_intensities_roi_268_3_Tg_striatum_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Striatum/268_3_Tg_s4_percentage_of_ions_within_striatum.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_268_3_Tg_striatum_df)[1] = "268_3_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_268_3_Tg_striatum_df$ions <- rownames(percentage_of_ion_intensities_roi_268_3_Tg_striatum_df)
```

Below we combine all the normalized percentage.

```{r}
dfs_to_merge <- list(percentage_of_ion_intensities_roi_226_a2_wt_striatum_df, percentage_of_ion_intensities_roi_225_4wt_striatum_df, percentage_of_ion_intensities_roi_225_a1wt_striatum_df, percentage_of_ion_intensities_roi_208_5wt_striatum_df, percentage_of_ion_intensities_roi_209_2wt_striatum_df, percentage_of_ion_intensities_roi_278_a2_wt_striatum_df, percentage_of_ion_intensities_roi_191_a3wt_striatum_df, percentage_of_ion_intensities_roi_252_8_wt_striatum_df, percentage_of_ion_intensities_roi_268_a3_wt_striatum_df, percentage_of_ion_intensities_roi_225_a2tg_striatum_df, percentage_of_ion_intensities_roi_270_5_Tg_striatum_df, percentage_of_ion_intensities_roi_225_3tg_striatum_df, percentage_of_ion_intensities_roi_270_a1_Tg_striatum_df, percentage_of_ion_intensities_roi_226_a1tg_striatum_df, percentage_of_ion_intensities_roi_210_a1tg_striatum_df, percentage_of_ion_intensities_roi_249_4_Tg_striatum_df, percentage_of_ion_intensities_roi_256_a3_Tg_striatum_df, percentage_of_ion_intensities_roi_268_3_Tg_striatum_df)
# Merge all into one
...
```{r}
processed_SE@metadata$results$`plots_pca.4385f137-70c6-426f-9170-b18c93202786`

processed_SE@metadata$results$`plots_pca.f1529b81-abff-4dc6-bab1-29a0dce2d2a2`
```
...
```{r}
SE_batches_final_combat@metadata$results$`plots_pca.6a9d4ce9-ae18-4403-8333-b43d56731865`

SE_batches_final_combat@metadata$results$`plots_pca.a86f8270-8ad8-4084-bde6-61ed0ed1381c`

SE_batches_final_combat@metadata$results$`plots_pca.044977d7-cf8b-47ee-a9cf-92568a380871`
```
...
```{r}
SE_batches_final_median@metadata$results$`plots_pca.dccd712d-b21b-4f1c-af93-441bc8949b15`

SE_batches_final_median@metadata$results$`plots_pca.482f8bbd-d789-4c5a-84a6-f313b2961661`

SE_batches_final_median@metadata$results$`plots_pca.13f13ad7-dae6-4270-b859-51ad97c92745`
```
...
```{r}
processed_SE@metadata$results$`plots_pca.2a83ebfe-a716-4065-a7d7-3ff0d5056c0c`

processed_SE@metadata$results$`plots_pca.2777d74d-a705-482c-9815-5c182414c8ff`
```
...
write.csv(assay_not_standardized, "D:/NEW All AGE Negative masks and roi sums/Average Striatum/AGE_negative_striatum_combat_batch_corrected_percentages.csv")
...
```{r}
SE_batches_final_combat@metadata$results$`plots_pca.5829b1bf-0e06-4ceb-b0b4-c82d8b9261d6`

SE_batches_final_combat@metadata$results$`plots_pca.4abc4ef9-ee40-41a2-aaad-2877f21ae087`

SE_batches_final_combat@metadata$results$`plots_pca.60869618-3825-4267-aff7-8306b6041b8b`
```
...
#write.csv(median_batch_corrected_data_ions_of_interest, file = "D:/NEW All AGE Negative masks and roi sums/Average Striatum/AGE_median_batch_corrected_sums_ions_of_interest.csv")
...
```{r}
SE_batches_final_median@metadata$results$`plots_pca.b9d45cfe-2cc8-46ff-8a3f-86a0b1f4444b`

SE_batches_final_median@metadata$results$`plots_pca.bfe5439e-3795-4064-81ef-0f19c575cbcd`

SE_batches_final_median@metadata$results$`plots_pca.8432171b-33df-4182-acb2-2397b720fa9c`
```
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots/6mo_vs_12mo_vs_22mo_significant_all_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots/wt_vs_tg_significant_6mo_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots/wt_vs_tg_significant_with_correction_6mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo[, ion] ~ treatment_final_6mo, main="Ion distribution WT vs Tg 6mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots/wt_vs_tg_significant_12mo_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots/wt_vs_tg_significant_with_correction_12mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo[, ion] ~ treatment_final_12mo, main="Ion distribution WT vs Tg 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots/wt_vs_tg_significant_22mo_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots/wt_vs_tg_significant_with_correction_22mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_22mo[, ion] ~ treatment_final_22mo, main="Ion distribution WT vs Tg 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots/6mo_vs_12mo_vs_22mo_significant_wt_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots/6mo_vs_12mo_vs_22mo_significant_with_correction_wt_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots/6mo_vs_12mo_vs_22mo_significant_tg_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots/6mo_vs_12mo_vs_22mo_significant_with_correction_tg_ANOVA_ion_",ion,".png"))
...
write.csv(final_aov_dataframe_with_correction_anova_all, 'D:/NEW All AGE Negative masks and roi sums/Average Striatum/Average Striatum Statistical Testing Results Normalized By Pixel/AGE_striatum_all_samples_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_6mo_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Striatum/Average Striatum Statistical Testing Results Normalized By Pixel/AGE_6mo_striatum_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_12mo_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Striatum/Average Striatum Statistical Testing Results Normalized By Pixel/AGE_12mo_striatum_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_22mo_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Striatum/Average Striatum Statistical Testing Results Normalized By Pixel/AGE_22mo_striatum_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Striatum/Average Striatum Statistical Testing Results Normalized By Pixel/AGE_striatum_wt_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Striatum/Average Striatum Statistical Testing Results Normalized By Pixel/AGE_striatum_tg_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
```
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_12mo_wt[, ion] ~ factor(treatment_final_wt_6mo_12mo, levels = c('6mo', '12mo')), main="Ion distribution wt 6mo vs 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_22mo_wt[, ion] ~ factor(treatment_final_wt_6mo_22mo, levels = c('6mo', '22mo')), main="Ion distribution wt 6mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo_22mo_wt[, ion] ~ factor(treatment_final_wt_12mo_22mo, levels = c('12mo', '22mo')), main="Ion distribution wt 12mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_12mo_tg[, ion] ~ factor(treatment_final_tg_6mo_12mo, levels = c('6mo', '12mo')), main="Ion distribution tg 6mo vs 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_22mo_tg[, ion] ~ factor(treatment_final_tg_6mo_22mo, levels = c('6mo', '22mo')), main="Ion distribution tg 6mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo_22mo_tg[, ion] ~ factor(treatment_final_tg_12mo_22mo, levels = c('12mo', '22mo')), main="Ion distribution tg 12mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_12mo_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Striatum/Average Striatum Statistical Testing Results Within Phenotype Testing/AGE_negative_striatum_6mo_vs_12mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_22mo_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Striatum/Average Striatum Statistical Testing Results Within Phenotype Testing/AGE_negative_striatum_6mo_vs_22mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_12mo_22mo_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Striatum/Average Striatum Statistical Testing Results Within Phenotype Testing/AGE_negative_striatum_12mo_vs_22mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_12mo_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Striatum/Average Striatum Statistical Testing Results Within Phenotype Testing/AGE_negative_striatum_6mo_vs_12mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_22mo_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Striatum/Average Striatum Statistical Testing Results Within Phenotype Testing/AGE_negative_striatum_6mo_vs_22mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_12mo_22mo_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Striatum/Average Striatum Statistical Testing Results Within Phenotype Testing/AGE_negative_striatum_12mo_vs_22mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
```
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots For Paper/negative_striatum_732_5503_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Striatum/Boxplots For Paper/negative_striatum_871_5392_boxplot.tiff", units="in", width=5, height=5, res=300)
