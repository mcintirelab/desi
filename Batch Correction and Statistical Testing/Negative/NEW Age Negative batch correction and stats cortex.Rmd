---
title: "NEW Age Negative batch correction and stats cortex"
...
```{r}
percentage_of_ion_intensities_roi_226_a2_wt_cortex_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Cortex/226_a2_wt_s2_percentage_of_ions_within_cortex.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_226_a2_wt_cortex_df)[1] = "226_a2_wt"
# Make row names into column
percentage_of_ion_intensities_roi_226_a2_wt_cortex_df$ions <- rownames(percentage_of_ion_intensities_roi_226_a2_wt_cortex_df)

percentage_of_ion_intensities_roi_225_4wt_cortex_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Cortex/225_4wt_percentage_of_ions_within_cortex.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_4wt_cortex_df)[1] = "225_4wt"
# Make row names into column
percentage_of_ion_intensities_roi_225_4wt_cortex_df$ions <- rownames(percentage_of_ion_intensities_roi_225_4wt_cortex_df)

percentage_of_ion_intensities_roi_225_a1wt_cortex_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Cortex/225_a1wt_percentage_of_ions_within_cortex.csv', row.names = 1)
# Rename column
...
percentage_of_ion_intensities_roi_208_5wt_cortex_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Cortex/208_5wt_percentage_of_ions_within_cortex.csv', row.names = 1)
# Rename column
...
percentage_of_ion_intensities_roi_209_2wt_cortex_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Cortex/209_2wt_percentage_of_ions_within_cortex.csv', row.names = 1)
# Rename column
...
percentage_of_ion_intensities_roi_278_a2_wt_cortex_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Cortex/278_a2_wt_s1_percentage_of_ions_within_cortex.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_278_a2_wt_cortex_df)[1] = "278_a2_wt"
# Make row names into column
percentage_of_ion_intensities_roi_278_a2_wt_cortex_df$ions <- rownames(percentage_of_ion_intensities_roi_278_a2_wt_cortex_df)

percentage_of_ion_intensities_roi_191_a3wt_cortex_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Cortex/191_a3wt_percentage_of_ions_within_cortex.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_191_a3wt_cortex_df)[1] = "191_a3wt"
# Make row names into column
percentage_of_ion_intensities_roi_191_a3wt_cortex_df$ions <- rownames(percentage_of_ion_intensities_roi_191_a3wt_cortex_df)

percentage_of_ion_intensities_roi_252_8_wt_cortex_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Cortex/252_8_wt_s1_percentage_of_ions_within_cortex.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_252_8_wt_cortex_df)[1] = "252_8_wt"
# Make row names into column
percentage_of_ion_intensities_roi_252_8_wt_cortex_df$ions <- rownames(percentage_of_ion_intensities_roi_252_8_wt_cortex_df)

percentage_of_ion_intensities_roi_268_a3_wt_cortex_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Cortex/268_a3_wt_s2_percentage_of_ions_within_cortex.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_268_a3_wt_cortex_df)[1] = "268_a3_wt"
# Make row names into column
percentage_of_ion_intensities_roi_268_a3_wt_cortex_df$ions <- rownames(percentage_of_ion_intensities_roi_268_a3_wt_cortex_df)

percentage_of_ion_intensities_roi_225_a2tg_cortex_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Cortex/225_a2tg_percentage_of_ions_within_cortex.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_a2tg_cortex_df)[1] = "225_a2tg"
# Make row names into column
percentage_of_ion_intensities_roi_225_a2tg_cortex_df$ions <- rownames(percentage_of_ion_intensities_roi_225_a2tg_cortex_df)

percentage_of_ion_intensities_roi_270_5_Tg_cortex_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Cortex/270_5_Tg_s4_percentage_of_ions_within_cortex.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_270_5_Tg_cortex_df)[1] = "270_5_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_270_5_Tg_cortex_df$ions <- rownames(percentage_of_ion_intensities_roi_270_5_Tg_cortex_df)

percentage_of_ion_intensities_roi_225_3tg_cortex_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Cortex/225_3tg_percentage_of_ions_within_cortex.csv', row.names = 1)
# Rename column
...
percentage_of_ion_intensities_roi_270_a1_Tg_cortex_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Cortex/270_a1_Tg_s1_percentage_of_ions_within_cortex.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_270_a1_Tg_cortex_df)[1] = "270_a1_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_270_a1_Tg_cortex_df$ions <- rownames(percentage_of_ion_intensities_roi_270_a1_Tg_cortex_df)

percentage_of_ion_intensities_roi_226_a1tg_cortex_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Cortex/226_a1tg_percentage_of_ions_within_cortex.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_226_a1tg_cortex_df)[1] = "226_a1tg"
# Make row names into column
percentage_of_ion_intensities_roi_226_a1tg_cortex_df$ions <- rownames(percentage_of_ion_intensities_roi_226_a1tg_cortex_df)

percentage_of_ion_intensities_roi_210_a1tg_cortex_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Cortex/210_a1tg_percentage_of_ions_within_cortex.csv', row.names = 1)
# Rename column
...
percentage_of_ion_intensities_roi_249_4_Tg_cortex_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Cortex/249_4_Tg_s1_percentage_of_ions_within_cortex.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_249_4_Tg_cortex_df)[1] = "249_4_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_249_4_Tg_cortex_df$ions <- rownames(percentage_of_ion_intensities_roi_249_4_Tg_cortex_df)

percentage_of_ion_intensities_roi_256_a3_Tg_cortex_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Cortex/256_a3_Tg_s1_percentage_of_ions_within_cortex.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_256_a3_Tg_cortex_df)[1] = "256_a3_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_256_a3_Tg_cortex_df$ions <- rownames(percentage_of_ion_intensities_roi_256_a3_Tg_cortex_df)

percentage_of_ion_intensities_roi_268_3_Tg_cortex_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Cortex/268_3_Tg_s4_percentage_of_ions_within_cortex.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_268_3_Tg_cortex_df)[1] = "268_3_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_268_3_Tg_cortex_df$ions <- rownames(percentage_of_ion_intensities_roi_268_3_Tg_cortex_df)
```

Below we combine all the normalized percentage.

```{r}
dfs_to_merge <- list(percentage_of_ion_intensities_roi_226_a2_wt_cortex_df, percentage_of_ion_intensities_roi_225_4wt_cortex_df, percentage_of_ion_intensities_roi_225_a1wt_cortex_df, percentage_of_ion_intensities_roi_208_5wt_cortex_df, percentage_of_ion_intensities_roi_209_2wt_cortex_df, percentage_of_ion_intensities_roi_278_a2_wt_cortex_df, percentage_of_ion_intensities_roi_191_a3wt_cortex_df, percentage_of_ion_intensities_roi_252_8_wt_cortex_df, percentage_of_ion_intensities_roi_268_a3_wt_cortex_df, percentage_of_ion_intensities_roi_225_a2tg_cortex_df, percentage_of_ion_intensities_roi_270_5_Tg_cortex_df, percentage_of_ion_intensities_roi_225_3tg_cortex_df, percentage_of_ion_intensities_roi_270_a1_Tg_cortex_df, percentage_of_ion_intensities_roi_226_a1tg_cortex_df, percentage_of_ion_intensities_roi_210_a1tg_cortex_df, percentage_of_ion_intensities_roi_249_4_Tg_cortex_df, percentage_of_ion_intensities_roi_256_a3_Tg_cortex_df, percentage_of_ion_intensities_roi_268_3_Tg_cortex_df)
# Merge all into one
...
```{r}
processed_SE@metadata$results$`plots_pca.25648bce-a276-48f2-8dc9-f31607e96a69`

processed_SE@metadata$results$`plots_pca.bd906435-5a86-4a69-8407-fb11ba6d92bd`
```
...
```{r}
SE_batches_final_combat@metadata$results$`plots_pca.6329fc51-5e72-4976-8ef1-321aeae8c982`

SE_batches_final_combat@metadata$results$`plots_pca.7d673d2d-fbfb-4196-b36c-54ecb5e01a82`

SE_batches_final_combat@metadata$results$`plots_pca.40489c3f-2fe6-45e3-bd9c-ac361ab1fdf5`
```
...
```{r}
SE_batches_final_median@metadata$results$`plots_pca.c99c04a2-df6e-4d3e-94f4-a293bc224502`

SE_batches_final_median@metadata$results$`plots_pca.44b347ea-9468-4a86-afb1-3776c31f7674`

SE_batches_final_median@metadata$results$`plots_pca.382d8010-9e4f-4bcc-87fb-434638ccbb3c`
```
...
```{r}
processed_SE@metadata$results$`plots_pca.03285461-ff85-43db-a4b2-c3a6f940859f`

processed_SE@metadata$results$`plots_pca.2f5af624-9d04-42c1-b86a-10a720a5c729`
```
...
write.csv(assay_not_standardized, "D:/NEW All AGE Negative masks and roi sums/Average Cortex/AGE_negative_cortex_combat_batch_corrected_percentages.csv")
...
```{r}
SE_batches_final_combat@metadata$results$`plots_pca.5c0a780f-4fcb-44b8-9015-5cc1d875b809`

SE_batches_final_combat@metadata$results$`plots_pca.45767b5a-15ca-40c4-983b-c5fea68d201b`

SE_batches_final_combat@metadata$results$`plots_pca.df676944-21d2-4289-8d02-3d4149fb2587`
```
...
#write.csv(median_batch_corrected_data_ions_of_interest, file = "D:/NEW All AGE Negative masks and roi sums/Average Cortex/AGE_median_batch_corrected_sums_ions_of_interest.csv")
...
```{r}
SE_batches_final_median@metadata$results$`plots_pca.2c100b10-a07e-4512-8eeb-aa5d110e6c38`

SE_batches_final_median@metadata$results$`plots_pca.bd163aaa-3a55-41b6-b776-2aa2784a241d`

SE_batches_final_median@metadata$results$`plots_pca.5135241e-364e-491f-9772-c0e473f0d2a0`
```
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots/6mo_vs_12mo_vs_22mo_significant_all_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots/wt_vs_tg_significant_6mo_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots/wt_vs_tg_significant_with_correction_6mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo[, ion] ~ treatment_final_6mo, main="Ion distribution WT vs Tg 6mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots/wt_vs_tg_significant_12mo_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots/wt_vs_tg_significant_with_correction_12mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo[, ion] ~ treatment_final_12mo, main="Ion distribution WT vs Tg 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots/wt_vs_tg_significant_22mo_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots/wt_vs_tg_significant_with_correction_22mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_22mo[, ion] ~ treatment_final_22mo, main="Ion distribution WT vs Tg 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots/6mo_vs_12mo_vs_22mo_significant_wt_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots/6mo_vs_12mo_vs_22mo_significant_with_correction_wt_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots/6mo_vs_12mo_vs_22mo_significant_tg_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots/6mo_vs_12mo_vs_22mo_significant_with_correction_tg_ANOVA_ion_",ion,".png"))
...
write.csv(final_aov_dataframe_with_correction_anova_all, 'D:/NEW All AGE Negative masks and roi sums/Average Cortex/Average Cortex Statistical Testing Results Normalized By Pixel/AGE_cortex_all_samples_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_6mo_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Cortex/Average Cortex Statistical Testing Results Normalized By Pixel/AGE_6mo_cortex_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_12mo_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Cortex/Average Cortex Statistical Testing Results Normalized By Pixel/AGE_12mo_cortex_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_22mo_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Cortex/Average Cortex Statistical Testing Results Normalized By Pixel/AGE_22mo_cortex_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Cortex/Average Cortex Statistical Testing Results Normalized By Pixel/AGE_cortex_wt_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Cortex/Average Cortex Statistical Testing Results Normalized By Pixel/AGE_cortex_tg_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
```
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_12mo_wt[, ion] ~ factor(treatment_final_wt_6mo_12mo, levels = c('6mo', '12mo')), main="Ion distribution wt 6mo vs 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_22mo_wt[, ion] ~ factor(treatment_final_wt_6mo_22mo, levels = c('6mo', '22mo')), main="Ion distribution wt 6mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo_22mo_wt[, ion] ~ factor(treatment_final_wt_12mo_22mo, levels = c('12mo', '22mo')), main="Ion distribution wt 12mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_12mo_tg[, ion] ~ factor(treatment_final_tg_6mo_12mo, levels = c('6mo', '12mo')), main="Ion distribution tg 6mo vs 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_22mo_tg[, ion] ~ factor(treatment_final_tg_6mo_22mo, levels = c('6mo', '22mo')), main="Ion distribution tg 6mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo_22mo_tg[, ion] ~ factor(treatment_final_tg_12mo_22mo, levels = c('12mo', '22mo')), main="Ion distribution tg 12mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_12mo_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Cortex/Average Cortex Statistical Testing Results Within Phenotype Testing/AGE_negative_cortex_6mo_vs_12mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_22mo_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Cortex/Average Cortex Statistical Testing Results Within Phenotype Testing/AGE_negative_cortex_6mo_vs_22mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_12mo_22mo_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Cortex/Average Cortex Statistical Testing Results Within Phenotype Testing/AGE_negative_cortex_12mo_vs_22mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_12mo_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Cortex/Average Cortex Statistical Testing Results Within Phenotype Testing/AGE_negative_cortex_6mo_vs_12mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_22mo_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Cortex/Average Cortex Statistical Testing Results Within Phenotype Testing/AGE_negative_cortex_6mo_vs_22mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_12mo_22mo_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Cortex/Average Cortex Statistical Testing Results Within Phenotype Testing/AGE_negative_cortex_12mo_vs_22mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
```
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots For Paper/negative_cortex_732_5503_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Cortex/Boxplots For Paper/negative_cortex_871_5392_boxplot.tiff", units="in", width=5, height=5, res=300)
