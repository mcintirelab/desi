---
title: "NEW AGE Negative batch correction and stats globus pallidus"
...
```{r}
percentage_of_ion_intensities_roi_226_a2_wt_globus_pallidus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/226_a2_wt_s2_percentage_of_ions_within_globus_pallidus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_226_a2_wt_globus_pallidus_df)[1] = "226_a2_wt"
# Make row names into column
percentage_of_ion_intensities_roi_226_a2_wt_globus_pallidus_df$ions <- rownames(percentage_of_ion_intensities_roi_226_a2_wt_globus_pallidus_df)

percentage_of_ion_intensities_roi_225_4wt_globus_pallidus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/225_4wt_percentage_of_ions_within_globus_pallidus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_4wt_globus_pallidus_df)[1] = "225_4wt"
# Make row names into column
percentage_of_ion_intensities_roi_225_4wt_globus_pallidus_df$ions <- rownames(percentage_of_ion_intensities_roi_225_4wt_globus_pallidus_df)

percentage_of_ion_intensities_roi_225_a1wt_globus_pallidus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/225_a1wt_percentage_of_ions_within_globus_pallidus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_a1wt_globus_pallidus_df)[1] = "225_a1wt"
# Make row names into column
percentage_of_ion_intensities_roi_225_a1wt_globus_pallidus_df$ions <- rownames(percentage_of_ion_intensities_roi_225_a1wt_globus_pallidus_df)

percentage_of_ion_intensities_roi_208_5wt_globus_pallidus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/208_5wt_percentage_of_ions_within_globus_pallidus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_208_5wt_globus_pallidus_df)[1] = "208_5wt"
# Make row names into column
percentage_of_ion_intensities_roi_208_5wt_globus_pallidus_df$ions <- rownames(percentage_of_ion_intensities_roi_208_5wt_globus_pallidus_df)

percentage_of_ion_intensities_roi_209_2wt_globus_pallidus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/209_2wt_percentage_of_ions_within_globus_pallidus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_209_2wt_globus_pallidus_df)[1] = "209_2wt"
# Make row names into column
percentage_of_ion_intensities_roi_209_2wt_globus_pallidus_df$ions <- rownames(percentage_of_ion_intensities_roi_209_2wt_globus_pallidus_df)

percentage_of_ion_intensities_roi_278_a2_wt_globus_pallidus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/278_a2_wt_s1_percentage_of_ions_within_globus_pallidus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_278_a2_wt_globus_pallidus_df)[1] = "278_a2_wt"
# Make row names into column
percentage_of_ion_intensities_roi_278_a2_wt_globus_pallidus_df$ions <- rownames(percentage_of_ion_intensities_roi_278_a2_wt_globus_pallidus_df)

percentage_of_ion_intensities_roi_191_a3wt_globus_pallidus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/191_a3wt_percentage_of_ions_within_globus_pallidus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_191_a3wt_globus_pallidus_df)[1] = "191_a3wt"
# Make row names into column
percentage_of_ion_intensities_roi_191_a3wt_globus_pallidus_df$ions <- rownames(percentage_of_ion_intensities_roi_191_a3wt_globus_pallidus_df)

percentage_of_ion_intensities_roi_252_8_wt_globus_pallidus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/252_8_wt_s1_percentage_of_ions_within_globus_pallidus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_252_8_wt_globus_pallidus_df)[1] = "252_8_wt"
# Make row names into column
percentage_of_ion_intensities_roi_252_8_wt_globus_pallidus_df$ions <- rownames(percentage_of_ion_intensities_roi_252_8_wt_globus_pallidus_df)

percentage_of_ion_intensities_roi_268_a3_wt_globus_pallidus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/268_a3_wt_s2_percentage_of_ions_within_globus_pallidus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_268_a3_wt_globus_pallidus_df)[1] = "268_a3_wt"
# Make row names into column
percentage_of_ion_intensities_roi_268_a3_wt_globus_pallidus_df$ions <- rownames(percentage_of_ion_intensities_roi_268_a3_wt_globus_pallidus_df)

percentage_of_ion_intensities_roi_225_a2tg_globus_pallidus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/225_a2tg_percentage_of_ions_within_globus_pallidus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_a2tg_globus_pallidus_df)[1] = "225_a2tg"
# Make row names into column
percentage_of_ion_intensities_roi_225_a2tg_globus_pallidus_df$ions <- rownames(percentage_of_ion_intensities_roi_225_a2tg_globus_pallidus_df)

percentage_of_ion_intensities_roi_270_5_Tg_globus_pallidus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/270_5_Tg_s4_percentage_of_ions_within_globus_pallidus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_270_5_Tg_globus_pallidus_df)[1] = "270_5_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_270_5_Tg_globus_pallidus_df$ions <- rownames(percentage_of_ion_intensities_roi_270_5_Tg_globus_pallidus_df)

percentage_of_ion_intensities_roi_225_3tg_globus_pallidus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/225_3tg_percentage_of_ions_within_globus_pallidus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_3tg_globus_pallidus_df)[1] = "225_3tg"
# Make row names into column
percentage_of_ion_intensities_roi_225_3tg_globus_pallidus_df$ions <- rownames(percentage_of_ion_intensities_roi_225_3tg_globus_pallidus_df)

percentage_of_ion_intensities_roi_270_a1_Tg_globus_pallidus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/270_a1_Tg_s1_percentage_of_ions_within_globus_pallidus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_270_a1_Tg_globus_pallidus_df)[1] = "270_a1_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_270_a1_Tg_globus_pallidus_df$ions <- rownames(percentage_of_ion_intensities_roi_270_a1_Tg_globus_pallidus_df)

percentage_of_ion_intensities_roi_226_a1tg_globus_pallidus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/226_a1tg_percentage_of_ions_within_globus_pallidus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_226_a1tg_globus_pallidus_df)[1] = "226_a1tg"
# Make row names into column
percentage_of_ion_intensities_roi_226_a1tg_globus_pallidus_df$ions <- rownames(percentage_of_ion_intensities_roi_226_a1tg_globus_pallidus_df)

percentage_of_ion_intensities_roi_210_a1tg_globus_pallidus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/210_a1tg_percentage_of_ions_within_globus_pallidus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_210_a1tg_globus_pallidus_df)[1] = "210_a1tg"
# Make row names into column
percentage_of_ion_intensities_roi_210_a1tg_globus_pallidus_df$ions <- rownames(percentage_of_ion_intensities_roi_210_a1tg_globus_pallidus_df)

percentage_of_ion_intensities_roi_249_4_Tg_globus_pallidus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/249_4_Tg_s1_percentage_of_ions_within_globus_pallidus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_249_4_Tg_globus_pallidus_df)[1] = "249_4_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_249_4_Tg_globus_pallidus_df$ions <- rownames(percentage_of_ion_intensities_roi_249_4_Tg_globus_pallidus_df)

percentage_of_ion_intensities_roi_256_a3_Tg_globus_pallidus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/256_a3_Tg_s1_percentage_of_ions_within_globus_pallidus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_256_a3_Tg_globus_pallidus_df)[1] = "256_a3_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_256_a3_Tg_globus_pallidus_df$ions <- rownames(percentage_of_ion_intensities_roi_256_a3_Tg_globus_pallidus_df)

percentage_of_ion_intensities_roi_268_3_Tg_globus_pallidus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/268_3_Tg_s4_percentage_of_ions_within_globus_pallidus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_268_3_Tg_globus_pallidus_df)[1] = "268_3_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_268_3_Tg_globus_pallidus_df$ions <- rownames(percentage_of_ion_intensities_roi_268_3_Tg_globus_pallidus_df)
```

Below we combine all the normalized percentage.

```{r}
dfs_to_merge <- list(percentage_of_ion_intensities_roi_226_a2_wt_globus_pallidus_df, percentage_of_ion_intensities_roi_225_4wt_globus_pallidus_df, percentage_of_ion_intensities_roi_225_a1wt_globus_pallidus_df, percentage_of_ion_intensities_roi_208_5wt_globus_pallidus_df, percentage_of_ion_intensities_roi_209_2wt_globus_pallidus_df, percentage_of_ion_intensities_roi_278_a2_wt_globus_pallidus_df, percentage_of_ion_intensities_roi_191_a3wt_globus_pallidus_df, percentage_of_ion_intensities_roi_252_8_wt_globus_pallidus_df, percentage_of_ion_intensities_roi_268_a3_wt_globus_pallidus_df, percentage_of_ion_intensities_roi_225_a2tg_globus_pallidus_df, percentage_of_ion_intensities_roi_270_5_Tg_globus_pallidus_df, percentage_of_ion_intensities_roi_225_3tg_globus_pallidus_df, percentage_of_ion_intensities_roi_270_a1_Tg_globus_pallidus_df, percentage_of_ion_intensities_roi_226_a1tg_globus_pallidus_df, percentage_of_ion_intensities_roi_210_a1tg_globus_pallidus_df, percentage_of_ion_intensities_roi_249_4_Tg_globus_pallidus_df, percentage_of_ion_intensities_roi_256_a3_Tg_globus_pallidus_df, percentage_of_ion_intensities_roi_268_3_Tg_globus_pallidus_df)
# Merge all into one
...
```{r}
processed_SE@metadata$results$`plots_pca.7b4d53ec-e34f-4f5e-bec2-9fbf2c9ebb11`

processed_SE@metadata$results$`plots_pca.edc29ff8-c89a-47f9-b0d8-f44f18c82e9a`
```
...
```{r}
SE_batches_final_combat@metadata$results$`plots_pca.11859232-9f30-4b36-9f04-4854b4c1a8f1`

SE_batches_final_combat@metadata$results$`plots_pca.61932052-7508-4185-9cf8-d6d4ffd2ed5d`

SE_batches_final_combat@metadata$results$`plots_pca.d4add769-d67b-4812-b96c-11a449079861`
```
...
```{r}
SE_batches_final_median@metadata$results$`plots_pca.408669af-d732-4998-b00b-018e8715fef0`

SE_batches_final_median@metadata$results$`plots_pca.f1395c3c-e3fc-40b6-a48f-a5296124fe0d`

SE_batches_final_median@metadata$results$`plots_pca.3325978b-0d2f-4640-ad86-c6c493dba259`
```
...
```{r}
processed_SE@metadata$results$`plots_pca.3d33b7f2-f6e4-431a-a4b3-0f93c1339d2c`

processed_SE@metadata$results$`plots_pca.e727331a-12cf-462e-83c9-16eaaaa91cad`
```
...
write.csv(assay_not_standardized, "D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/AGE_negative_globus_pallidus_combat_batch_corrected_percentages.csv")
...
```{r}
SE_batches_final_combat@metadata$results$`plots_pca.64808ace-291c-4d78-8f83-2301d8bef3f0`

SE_batches_final_combat@metadata$results$`plots_pca.2be149ce-b2a5-41df-8076-50e1c0b1201a`

SE_batches_final_combat@metadata$results$`plots_pca.d15a3f3a-75bb-476b-9587-6afc427282e9`
```
...
#write.csv(median_batch_corrected_data_ions_of_interest, file = "D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/AGE_median_batch_corrected_sums_ions_of_interest.csv")
...
```{r}
SE_batches_final_median@metadata$results$`plots_pca.ecafad7b-bec8-4a67-8215-c5354b99e35f`

SE_batches_final_median@metadata$results$`plots_pca.49b2c9fc-46cb-42b0-95ca-b81b72a8e80f`

SE_batches_final_median@metadata$results$`plots_pca.fbbad782-9b45-48a9-99dd-4663342622da`
```
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots/6mo_vs_12mo_vs_22mo_significant_all_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots/wt_vs_tg_significant_6mo_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots/wt_vs_tg_significant_with_correction_6mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo[, ion] ~ treatment_final_6mo, main="Ion distribution WT vs Tg 6mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots/wt_vs_tg_significant_12mo_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots/wt_vs_tg_significant_with_correction_12mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo[, ion] ~ treatment_final_12mo, main="Ion distribution WT vs Tg 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots/wt_vs_tg_significant_22mo_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots/wt_vs_tg_significant_with_correction_22mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_22mo[, ion] ~ treatment_final_22mo, main="Ion distribution WT vs Tg 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots/6mo_vs_12mo_vs_22mo_significant_wt_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots/6mo_vs_12mo_vs_22mo_significant_with_correction_wt_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots/6mo_vs_12mo_vs_22mo_significant_tg_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots/6mo_vs_12mo_vs_22mo_significant_with_correction_tg_ANOVA_ion_",ion,".png"))
...
write.csv(final_aov_dataframe_with_correction_anova_all, 'D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Average Globus Pallidus Statistical Testing Results Normalized By Pixel/AGE_globus_pallidus_all_samples_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_6mo_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Average Globus Pallidus Statistical Testing Results Normalized By Pixel/AGE_6mo_globus_pallidus_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_12mo_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Average Globus Pallidus Statistical Testing Results Normalized By Pixel/AGE_12mo_globus_pallidus_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_22mo_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Average Globus Pallidus Statistical Testing Results Normalized By Pixel/AGE_22mo_globus_pallidus_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Average Globus Pallidus Statistical Testing Results Normalized By Pixel/AGE_globus_pallidus_wt_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Average Globus Pallidus Statistical Testing Results Normalized By Pixel/AGE_globus_pallidus_tg_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
```
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_12mo_wt[, ion] ~ factor(treatment_final_wt_6mo_12mo, levels = c('6mo', '12mo')), main="Ion distribution wt 6mo vs 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_22mo_wt[, ion] ~ factor(treatment_final_wt_6mo_22mo, levels = c('6mo', '22mo')), main="Ion distribution wt 6mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo_22mo_wt[, ion] ~ factor(treatment_final_wt_12mo_22mo, levels = c('12mo', '22mo')), main="Ion distribution wt 12mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_12mo_tg[, ion] ~ factor(treatment_final_tg_6mo_12mo, levels = c('6mo', '12mo')), main="Ion distribution tg 6mo vs 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_22mo_tg[, ion] ~ factor(treatment_final_tg_6mo_22mo, levels = c('6mo', '22mo')), main="Ion distribution tg 6mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo_22mo_tg[, ion] ~ factor(treatment_final_tg_12mo_22mo, levels = c('12mo', '22mo')), main="Ion distribution tg 12mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_12mo_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Average Globus Pallidus Statistical Testing Results Within Phenotype Testing/AGE_negative_globus_pallidus_6mo_vs_12mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_22mo_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Average Globus Pallidus Statistical Testing Results Within Phenotype Testing/AGE_negative_globus_pallidus_6mo_vs_22mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_12mo_22mo_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Average Globus Pallidus Statistical Testing Results Within Phenotype Testing/AGE_negative_globus_pallidus_12mo_vs_22mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_12mo_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Average Globus Pallidus Statistical Testing Results Within Phenotype Testing/AGE_negative_globus_pallidus_6mo_vs_12mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_22mo_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Average Globus Pallidus Statistical Testing Results Within Phenotype Testing/AGE_negative_globus_pallidus_6mo_vs_22mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_12mo_22mo_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Average Globus Pallidus Statistical Testing Results Within Phenotype Testing/AGE_negative_globus_pallidus_12mo_vs_22mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
```
...
my_comparisons <- list(c("wt_6mo", "tg_6mo"), c("tg_6mo", "tg_12mo"), c("tg_6mo", "tg_22mo"), c("tg_12mo", "tg_22mo"))

tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_124_0071_boxplot.tiff", units="in", width=5, height=5, res=300)
...
# Specify statistical comparisons
my_comparisons <- list(c("wt_6mo", "tg_6mo"), c("tg_6mo", "tg_12mo"), c("tg_6mo", "tg_22mo"))

tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_145_0612_boxplot.tiff", units="in", width=5, height=5, res=300)
...
# Specify statistical comparisons
my_comparisons <- list(c("wt_6mo", "tg_6mo"))

tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_301_2172_boxplot.tiff", units="in", width=5, height=5, res=300)
...
ggboxplot(dataframe_final, x = "phenotype", y = 'Mol %', color = "phenotype", 
  ...
  theme(plot.title = element_text(hjust = 0.5)) +
  stat_compare_means(comparisons = my_comparisons, method = 't.test', symnum.args=list(cutpoints = c(0, 0.4), symbols = c("*"))) +
  scale_x_discrete(limits=c("wt_6mo", "tg_6mo", "wt_12mo", "tg_12mo", "wt_22mo", "tg_22mo"),labels=c("WT", "APPsw", "WT", "APPsw", "WT", "APPsw")) + 
      coord_cartesian(clip = 'off') +
    geom_text( size = 6, aes(x = c(1.1, 0, 0, 0, 0, 0, 3.1, 0, 0, 0, 0, 0, 5.1, 0, 0, 0, 0, 0), y = 0, label = c("6mo", "", "", "", "", "", "12mo", "", "", "", "", "", "22mo", "", "", "", "", ""),
    hjust = 0, vjust = 4)) + 
...
# Specify statistical comparisons
my_comparisons <- list(c("wt_6mo", "tg_6mo"), c("wt_12mo", "tg_12mo"))

tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_327_2329_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_328_2227_boxplot.tiff", units="in", width=5, height=5, res=300)
...
# Specify statistical comparisons
my_comparisons <- list(c("wt_6mo", "tg_6mo"), c("wt_12mo", "tg_12mo"), c("tg_6mo", "tg_22mo"))

grob <- grobTree(textGrob("ANOVA", x=0.48,  y= 0.98, hjust=0,
  gp=gpar(fontsize=10)))


tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_329_2451_boxplot.tiff", units="in", width=5, height=5, res=300)
...
# Plot
 annotation_custom(grob) +
  stat_compare_means(comparisons = my_comparisons, method = 't.test', symnum.args=list(cutpoints = c(0, 0.5), symbols = c("*"))) +
  scale_x_discrete(limits=c("wt_6mo", "tg_6mo", "wt_12mo", "tg_12mo", "wt_22mo", "tg_22mo"),labels=c("WT", "APPsw", "WT", "APPsw", "WT", "APPsw")) + 
      coord_cartesian(clip = 'off') +
    geom_text( size = 6, aes(x = c(1.1, 0, 0, 0, 0, 0, 3.1, 0, 0, 0, 0, 0, 5.1, 0, 0, 0, 0, 0), y = 0, label = c("6mo", "", "", "", "", "", "12mo", "", "", "", "", "", "22mo", "", "", "", "", ""),
    hjust = 0, vjust = 4)) + 
...
# Specify statistical comparisons
my_comparisons <- list(c("wt_12mo", "tg_12mo"))

tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_600_5060_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_601_5093_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_602_5082_boxplot.tiff", units="in", width=5, height=5, res=300)
...
# Specify statistical comparisons
my_comparisons <- list(c("tg_6mo", "tg_22mo"), c("tg_6mo", "tg_12mo"), c("tg_12mo", "tg_22mo"))

tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_673_4799_boxplot.tiff", units="in", width=5, height=5, res=300)
...
ggboxplot(dataframe_final, x = "phenotype", y = 'Mol %', color = "phenotype", 
  ...
  theme(plot.title = element_text(hjust = 0.5)) +
    stat_compare_means(comparisons = my_comparisons, method = "t.test", symnum.args=list(cutpoints = c(0, 1), symbols = c("*"))) +
scale_x_discrete(limits=c("wt_6mo", "tg_6mo", "wt_12mo", "tg_12mo", "wt_22mo", "tg_22mo"),labels=c("WT", "APPsw", "WT", "APPsw", "WT", "APPsw")) + 
      coord_cartesian(clip = 'off') +
    geom_text( size = 6, aes(x = c(1.1, 0, 0, 0, 0, 0, 3.1, 0, 0, 0, 0, 0, 5.1, 0, 0, 0, 0, 0), y = 0, label = c("6mo", "", "", "", "", "", "12mo", "", "", "", "", "", "22mo", "", "", "", "", ""),
    hjust = 0, vjust = 4)) + 
...
# Specify statistical comparisons
my_comparisons <- list(c("tg_12mo", "tg_22mo"))

tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_674_4805_boxplot.tiff", units="in", width=5, height=5, res=300)
...
# Specify statistical comparisons
my_comparisons <- list(c("tg_6mo", "tg_22mo"), c("tg_12mo", "tg_22mo"))

tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_683_4949_boxplot.tiff", units="in", width=5, height=5, res=300)
...
# Specify statistical comparisons
my_comparisons <- list(c("tg_6mo", "tg_12mo"), c("tg_12mo", "tg_22mo"))

tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_685_5149_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_700_5164_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_701_5146_boxplot.tiff", units="in", width=5, height=5, res=300)
...
# Specify statistical comparisons
my_comparisons <- list(c("wt_12mo", "tg_12mo"), c("tg_6mo", "tg_12mo"), c("tg_12mo", "tg_22mo"))

tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_702_5150_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_724_5035_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_725_5073_boxplot.tiff", units="in", width=5, height=5, res=300)
...
# Specify statistical comparisons
my_comparisons <- list(c("wt_12mo", "tg_12mo"), c("tg_6mo", "tg_22mo"))

tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_726_5419_boxplot.tiff", units="in", width=5, height=5, res=300)
...
# Specify statistical comparisons
my_comparisons <- list(c("wt_12mo", "tg_12mo"), c("tg_12mo", "tg_22mo"), c("tg_6mo", "tg_22mo"))

tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_727_5335_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_728_5511_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_746_5150_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_748_5185_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_749_5189_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_750_5399_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_751_5354_boxplot.tiff", units="in", width=5, height=5, res=300)
...
# Specify statistical comparisons
my_comparisons <- list(c("wt_6mo", "tg_6mo"), c("tg_6mo", "tg_12mo"), c("tg_12mo", "tg_22mo"))

tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_762_5073_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_763_5109_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_764_5199_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_766_5374_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_768_5317_boxplot.tiff", units="in", width=5, height=5, res=300)
...
Below we make a boxplot for 772.5136
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_772_5316_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_773_5358_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_775_5443_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_776_5504_boxplot.tiff", units="in", width=5, height=5, res=300)
...
dataframe_final$phenotype <- treatment_final_all
# Change name of column
colnames(dataframe_final)[colnames(dataframe_final) == "778.5600"] ="Mol %"

# Specify statistical comparisons
my_comparisons <- list(c("wt_6mo", "tg_6mo"))

tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_778_5600_boxplot.tiff", units="in", width=5, height=5, res=300)
...
Below we make a boxplot for 792.5430
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_792_5430_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_331_2636_boxplot.tiff", units="in", width=5, height=5, res=300)
...
Below we make a boxplot for ion 281.2491
...
dataframe_final$phenotype <- treatment_final_all
# Change name of column
colnames(dataframe_final)[colnames(dataframe_final) == "281.2491"] ="Mol %"

# Specify statistical comparisons
#my_comparisons <- list(c("wt_12mo", "wt_22mo"))

tiff("D:/NEW All AGE Negative masks and roi sums/Average Globus Pallidus/Boxplots For Paper/negative_globus_pallidus_281_2491_boxplot.tiff", units="in", width=5, height=5, res=300)

# make boxplot
ggboxplot(dataframe_final, x = "phenotype", y = 'Mol %', color = "phenotype", 
          add = "jitter", legend = "none", xlab = "") + 
  ggtitle('m/z: 281.2491 [-]') +
  theme(plot.title = element_text(hjust = 0.5))  +
  scale_x_discrete(limits=c("wt_6mo", "tg_6mo", "wt_12mo", "tg_12mo", "wt_22mo", "tg_22mo"),labels=c("WT", "APPsw", "WT", "APPsw", "WT", "APPsw")) + 
      coord_cartesian(clip = 'off') +
    geom_text( size = 6, aes(x = c(1.1, 0, 0, 0, 0, 0, 3.1, 0, 0, 0, 0, 0, 5.1, 0, 0, 0, 0, 0), y = 0, label = c("6mo", "", "", "", "", "", "12mo", "", "", "", "", "", "22mo", "", "", "", "", ""),
