---
title: "NEW Age Negative batch correction and stats white matter"
...
```{r}
percentage_of_ion_intensities_roi_226_a2_wt_white_matter_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average White Matter/226_a2_wt_s2_percentage_of_ions_within_white_matter.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_226_a2_wt_white_matter_df)[1] = "226_a2_wt"
# Make row names into column
percentage_of_ion_intensities_roi_226_a2_wt_white_matter_df$ions <- rownames(percentage_of_ion_intensities_roi_226_a2_wt_white_matter_df)

percentage_of_ion_intensities_roi_225_4wt_white_matter_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average White Matter/225_4wt_percentage_of_ions_within_white_matter.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_4wt_white_matter_df)[1] = "225_4wt"
# Make row names into column
percentage_of_ion_intensities_roi_225_4wt_white_matter_df$ions <- rownames(percentage_of_ion_intensities_roi_225_4wt_white_matter_df)

percentage_of_ion_intensities_roi_225_a1wt_white_matter_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average White Matter/225_a1wt_percentage_of_ions_within_white_matter.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_a1wt_white_matter_df)[1] = "225_a1wt"
# Make row names into column
percentage_of_ion_intensities_roi_225_a1wt_white_matter_df$ions <- rownames(percentage_of_ion_intensities_roi_225_a1wt_white_matter_df)

percentage_of_ion_intensities_roi_208_5wt_white_matter_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average White Matter/208_5wt_percentage_of_ions_within_white_matter.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_208_5wt_white_matter_df)[1] = "208_5wt"
# Make row names into column
percentage_of_ion_intensities_roi_208_5wt_white_matter_df$ions <- rownames(percentage_of_ion_intensities_roi_208_5wt_white_matter_df)

percentage_of_ion_intensities_roi_209_2wt_white_matter_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average White Matter/209_2wt_percentage_of_ions_within_white_matter.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_209_2wt_white_matter_df)[1] = "209_2wt"
# Make row names into column
percentage_of_ion_intensities_roi_209_2wt_white_matter_df$ions <- rownames(percentage_of_ion_intensities_roi_209_2wt_white_matter_df)

percentage_of_ion_intensities_roi_278_a2_wt_white_matter_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average White Matter/278_a2_wt_s1_percentage_of_ions_within_white_matter.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_278_a2_wt_white_matter_df)[1] = "278_a2_wt"
# Make row names into column
percentage_of_ion_intensities_roi_278_a2_wt_white_matter_df$ions <- rownames(percentage_of_ion_intensities_roi_278_a2_wt_white_matter_df)

percentage_of_ion_intensities_roi_191_a3wt_white_matter_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average White Matter/191_a3wt_percentage_of_ions_within_white_matter.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_191_a3wt_white_matter_df)[1] = "191_a3wt"
# Make row names into column
percentage_of_ion_intensities_roi_191_a3wt_white_matter_df$ions <- rownames(percentage_of_ion_intensities_roi_191_a3wt_white_matter_df)

percentage_of_ion_intensities_roi_252_8_wt_white_matter_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average White Matter/252_8_wt_s1_percentage_of_ions_within_white_matter.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_252_8_wt_white_matter_df)[1] = "252_8_wt"
# Make row names into column
percentage_of_ion_intensities_roi_252_8_wt_white_matter_df$ions <- rownames(percentage_of_ion_intensities_roi_252_8_wt_white_matter_df)

percentage_of_ion_intensities_roi_268_a3_wt_white_matter_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average White Matter/268_a3_wt_s2_percentage_of_ions_within_white_matter.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_268_a3_wt_white_matter_df)[1] = "268_a3_wt"
# Make row names into column
percentage_of_ion_intensities_roi_268_a3_wt_white_matter_df$ions <- rownames(percentage_of_ion_intensities_roi_268_a3_wt_white_matter_df)

percentage_of_ion_intensities_roi_225_a2tg_white_matter_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average White Matter/225_a2tg_percentage_of_ions_within_white_matter.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_a2tg_white_matter_df)[1] = "225_a2tg"
# Make row names into column
percentage_of_ion_intensities_roi_225_a2tg_white_matter_df$ions <- rownames(percentage_of_ion_intensities_roi_225_a2tg_white_matter_df)

percentage_of_ion_intensities_roi_270_5_Tg_white_matter_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average White Matter/270_5_Tg_s4_percentage_of_ions_within_white_matter.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_270_5_Tg_white_matter_df)[1] = "270_5_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_270_5_Tg_white_matter_df$ions <- rownames(percentage_of_ion_intensities_roi_270_5_Tg_white_matter_df)

percentage_of_ion_intensities_roi_225_3tg_white_matter_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average White Matter/225_3tg_percentage_of_ions_within_white_matter.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_3tg_white_matter_df)[1] = "225_3tg"
# Make row names into column
percentage_of_ion_intensities_roi_225_3tg_white_matter_df$ions <- rownames(percentage_of_ion_intensities_roi_225_3tg_white_matter_df)

percentage_of_ion_intensities_roi_270_a1_Tg_white_matter_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average White Matter/270_a1_Tg_s1_percentage_of_ions_within_white_matter.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_270_a1_Tg_white_matter_df)[1] = "270_a1_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_270_a1_Tg_white_matter_df$ions <- rownames(percentage_of_ion_intensities_roi_270_a1_Tg_white_matter_df)

percentage_of_ion_intensities_roi_226_a1tg_white_matter_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average White Matter/226_a1tg_percentage_of_ions_within_white_matter.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_226_a1tg_white_matter_df)[1] = "226_a1tg"
# Make row names into column
percentage_of_ion_intensities_roi_226_a1tg_white_matter_df$ions <- rownames(percentage_of_ion_intensities_roi_226_a1tg_white_matter_df)

percentage_of_ion_intensities_roi_210_a1tg_white_matter_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average White Matter/210_a1tg_percentage_of_ions_within_white_matter.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_210_a1tg_white_matter_df)[1] = "210_a1tg"
# Make row names into column
percentage_of_ion_intensities_roi_210_a1tg_white_matter_df$ions <- rownames(percentage_of_ion_intensities_roi_210_a1tg_white_matter_df)

percentage_of_ion_intensities_roi_249_4_Tg_white_matter_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average White Matter/249_4_Tg_s1_percentage_of_ions_within_white_matter.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_249_4_Tg_white_matter_df)[1] = "249_4_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_249_4_Tg_white_matter_df$ions <- rownames(percentage_of_ion_intensities_roi_249_4_Tg_white_matter_df)

percentage_of_ion_intensities_roi_256_a3_Tg_white_matter_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average White Matter/256_a3_Tg_s1_percentage_of_ions_within_white_matter.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_256_a3_Tg_white_matter_df)[1] = "256_a3_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_256_a3_Tg_white_matter_df$ions <- rownames(percentage_of_ion_intensities_roi_256_a3_Tg_white_matter_df)

percentage_of_ion_intensities_roi_268_3_Tg_white_matter_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average White Matter/268_3_Tg_s4_percentage_of_ions_within_white_matter.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_268_3_Tg_white_matter_df)[1] = "268_3_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_268_3_Tg_white_matter_df$ions <- rownames(percentage_of_ion_intensities_roi_268_3_Tg_white_matter_df)
```

Below we combine all the normalized percentage.

```{r}
dfs_to_merge <- list(percentage_of_ion_intensities_roi_226_a2_wt_white_matter_df, percentage_of_ion_intensities_roi_225_4wt_white_matter_df, percentage_of_ion_intensities_roi_225_a1wt_white_matter_df, percentage_of_ion_intensities_roi_208_5wt_white_matter_df, percentage_of_ion_intensities_roi_209_2wt_white_matter_df, percentage_of_ion_intensities_roi_278_a2_wt_white_matter_df, percentage_of_ion_intensities_roi_191_a3wt_white_matter_df, percentage_of_ion_intensities_roi_252_8_wt_white_matter_df, percentage_of_ion_intensities_roi_268_a3_wt_white_matter_df, percentage_of_ion_intensities_roi_225_a2tg_white_matter_df, percentage_of_ion_intensities_roi_270_5_Tg_white_matter_df, percentage_of_ion_intensities_roi_225_3tg_white_matter_df, percentage_of_ion_intensities_roi_270_a1_Tg_white_matter_df, percentage_of_ion_intensities_roi_226_a1tg_white_matter_df, percentage_of_ion_intensities_roi_210_a1tg_white_matter_df, percentage_of_ion_intensities_roi_249_4_Tg_white_matter_df, percentage_of_ion_intensities_roi_256_a3_Tg_white_matter_df, percentage_of_ion_intensities_roi_268_3_Tg_white_matter_df)
# Merge all into one
...
```{r}
processed_SE@metadata$results$`plots_pca.6837d691-d5ca-46d4-9163-fc20d2e30a64`

processed_SE@metadata$results$`plots_pca.824ef39b-2b0d-4021-9c45-5048e6cf6d8d`
```
...
```{r}
SE_batches_final_combat@metadata$results$`plots_pca.287d0c26-8c54-40c9-9a8b-d451836426bc`

SE_batches_final_combat@metadata$results$`plots_pca.5ac3f7aa-23c6-4588-a411-aaecb99276be`

SE_batches_final_combat@metadata$results$`plots_pca.c7e66996-4517-4cb8-b6dc-dc76845a2cb3`
```
...
```{r}
SE_batches_final_median@metadata$results$`plots_pca.233da708-b65f-4904-b6aa-86145f681886`

SE_batches_final_median@metadata$results$`plots_pca.f4ddeba5-29db-487e-b6f5-0164719b45a8`

SE_batches_final_median@metadata$results$`plots_pca.6ea9a18c-578d-4f85-a65f-1f528f787246`
```
...
```{r}
processed_SE@metadata$results$`plots_pca.3ccc249e-8c06-4ae3-9ddb-fc00e3b04959`

processed_SE@metadata$results$`plots_pca.9d0cecff-ec53-4713-931d-5695637bc64b`
```
...
write.csv(assay_not_standardized, "D:/NEW All AGE Negative masks and roi sums/Average White Matter/AGE_negative_white_matter_combat_batch_corrected_percentages.csv")
...
```{r}
SE_batches_final_combat@metadata$results$`plots_pca.4d261da6-93c2-46f9-a131-7c2fea247cfc`

SE_batches_final_combat@metadata$results$`plots_pca.e10db9b9-bcd9-40d9-a4af-aadfa586e4d7`

SE_batches_final_combat@metadata$results$`plots_pca.989d6be7-e14c-4c6a-8775-bd603c2c62cc`
```
...
#write.csv(median_batch_corrected_data_ions_of_interest, file = "D:/NEW All AGE Negative masks and roi sums/Average White Matter/AGE_median_batch_corrected_sums_ions_of_interest.csv")
...
```{r}
SE_batches_final_median@metadata$results$`plots_pca.9b472f5a-418f-43f9-864a-8e6547bdf82a`

SE_batches_final_median@metadata$results$`plots_pca.a0e92681-c3bd-40f2-90fa-5b70804b9088`

SE_batches_final_median@metadata$results$`plots_pca.af3e53a2-82eb-4bbe-b607-89b19e9402e9`
```
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots/6mo_vs_12mo_vs_22mo_significant_all_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots/wt_vs_tg_significant_6mo_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots/wt_vs_tg_significant_with_correction_6mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo[, ion] ~ treatment_final_6mo, main="Ion distribution WT vs Tg 6mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots/wt_vs_tg_significant_12mo_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots/wt_vs_tg_significant_with_correction_12mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo[, ion] ~ treatment_final_12mo, main="Ion distribution WT vs Tg 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots/wt_vs_tg_significant_22mo_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots/wt_vs_tg_significant_with_correction_22mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_22mo[, ion] ~ treatment_final_22mo, main="Ion distribution WT vs Tg 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots/6mo_vs_12mo_vs_22mo_significant_wt_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots/6mo_vs_12mo_vs_22mo_significant_with_correction_wt_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots/6mo_vs_12mo_vs_22mo_significant_tg_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots/6mo_vs_12mo_vs_22mo_significant_with_correction_tg_ANOVA_ion_",ion,".png"))
...
write.csv(final_aov_dataframe_with_correction_anova_all, 'D:/NEW All AGE Negative masks and roi sums/Average White Matter/Average White Matter Statistical Testing Results Normalized By Pixel/AGE_white_matter_all_samples_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_6mo_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average White Matter/Average White Matter Statistical Testing Results Normalized By Pixel/AGE_6mo_white_matter_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_12mo_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average White Matter/Average White Matter Statistical Testing Results Normalized By Pixel/AGE_12mo_white_matter_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_22mo_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average White Matter/Average White Matter Statistical Testing Results Normalized By Pixel/AGE_22mo_white_matter_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average White Matter/Average White Matter Statistical Testing Results Normalized By Pixel/AGE_white_matter_wt_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average White Matter/Average White Matter Statistical Testing Results Normalized By Pixel/AGE_white_matter_tg_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
```
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_12mo_wt[, ion] ~ factor(treatment_final_wt_6mo_12mo, levels = c('6mo', '12mo')), main="Ion distribution wt 6mo vs 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_22mo_wt[, ion] ~ factor(treatment_final_wt_6mo_22mo, levels = c('6mo', '22mo')), main="Ion distribution wt 6mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo_22mo_wt[, ion] ~ factor(treatment_final_wt_12mo_22mo, levels = c('12mo', '22mo')), main="Ion distribution wt 12mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_12mo_tg[, ion] ~ factor(treatment_final_tg_6mo_12mo, levels = c('6mo', '12mo')), main="Ion distribution tg 6mo vs 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_22mo_tg[, ion] ~ factor(treatment_final_tg_6mo_22mo, levels = c('6mo', '22mo')), main="Ion distribution tg 6mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo_22mo_tg[, ion] ~ factor(treatment_final_tg_12mo_22mo, levels = c('12mo', '22mo')), main="Ion distribution tg 12mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_12mo_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average White Matter/Average White Matter Statistical Testing Results Within Phenotype Testing/AGE_negative_white_matter_6mo_vs_12mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_22mo_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average White Matter/Average White Matter Statistical Testing Results Within Phenotype Testing/AGE_negative_white_matter_6mo_vs_22mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_12mo_22mo_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average White Matter/Average White Matter Statistical Testing Results Within Phenotype Testing/AGE_negative_white_matter_12mo_vs_22mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_12mo_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average White Matter/Average White Matter Statistical Testing Results Within Phenotype Testing/AGE_negative_white_matter_6mo_vs_12mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_22mo_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average White Matter/Average White Matter Statistical Testing Results Within Phenotype Testing/AGE_negative_white_matter_6mo_vs_22mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_12mo_22mo_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average White Matter/Average White Matter Statistical Testing Results Within Phenotype Testing/AGE_negative_white_matter_12mo_vs_22mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
```
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots For Paper/negative_white_matter_732_5503_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average White Matter/Boxplots For Paper/negative_white_matter_871_5392_boxplot.tiff", units="in", width=5, height=5, res=300)
