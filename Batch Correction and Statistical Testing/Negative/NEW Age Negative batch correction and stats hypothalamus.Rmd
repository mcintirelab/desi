---
title: "NEW Age Negative batch correction and stats hypothalamus"
...
```{r}
percentage_of_ion_intensities_roi_226_a2_wt_hypothalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/226_a2_wt_s2_percentage_of_ions_within_hypothalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_226_a2_wt_hypothalamus_df)[1] = "226_a2_wt"
# Make row names into column
percentage_of_ion_intensities_roi_226_a2_wt_hypothalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_226_a2_wt_hypothalamus_df)

percentage_of_ion_intensities_roi_225_4wt_hypothalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/225_4wt_percentage_of_ions_within_hypothalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_4wt_hypothalamus_df)[1] = "225_4wt"
# Make row names into column
percentage_of_ion_intensities_roi_225_4wt_hypothalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_225_4wt_hypothalamus_df)

percentage_of_ion_intensities_roi_225_a1wt_hypothalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/225_a1wt_percentage_of_ions_within_hypothalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_a1wt_hypothalamus_df)[1] = "225_a1wt"
# Make row names into column
percentage_of_ion_intensities_roi_225_a1wt_hypothalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_225_a1wt_hypothalamus_df)

percentage_of_ion_intensities_roi_208_5wt_hypothalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/208_5wt_percentage_of_ions_within_hypothalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_208_5wt_hypothalamus_df)[1] = "208_5wt"
# Make row names into column
percentage_of_ion_intensities_roi_208_5wt_hypothalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_208_5wt_hypothalamus_df)

percentage_of_ion_intensities_roi_209_2wt_hypothalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/209_2wt_percentage_of_ions_within_hypothalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_209_2wt_hypothalamus_df)[1] = "209_2wt"
# Make row names into column
percentage_of_ion_intensities_roi_209_2wt_hypothalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_209_2wt_hypothalamus_df)

percentage_of_ion_intensities_roi_278_a2_wt_hypothalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/278_a2_wt_s1_percentage_of_ions_within_hypothalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_278_a2_wt_hypothalamus_df)[1] = "278_a2_wt"
# Make row names into column
percentage_of_ion_intensities_roi_278_a2_wt_hypothalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_278_a2_wt_hypothalamus_df)

percentage_of_ion_intensities_roi_191_a3wt_hypothalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/191_a3wt_percentage_of_ions_within_hypothalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_191_a3wt_hypothalamus_df)[1] = "191_a3wt"
# Make row names into column
percentage_of_ion_intensities_roi_191_a3wt_hypothalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_191_a3wt_hypothalamus_df)

percentage_of_ion_intensities_roi_252_8_wt_hypothalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/252_8_wt_s1_percentage_of_ions_within_hypothalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_252_8_wt_hypothalamus_df)[1] = "252_8_wt"
# Make row names into column
percentage_of_ion_intensities_roi_252_8_wt_hypothalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_252_8_wt_hypothalamus_df)

percentage_of_ion_intensities_roi_268_a3_wt_hypothalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/268_a3_wt_s2_percentage_of_ions_within_hypothalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_268_a3_wt_hypothalamus_df)[1] = "268_a3_wt"
# Make row names into column
percentage_of_ion_intensities_roi_268_a3_wt_hypothalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_268_a3_wt_hypothalamus_df)

percentage_of_ion_intensities_roi_225_a2tg_hypothalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/225_a2tg_percentage_of_ions_within_hypothalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_a2tg_hypothalamus_df)[1] = "225_a2tg"
# Make row names into column
percentage_of_ion_intensities_roi_225_a2tg_hypothalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_225_a2tg_hypothalamus_df)

percentage_of_ion_intensities_roi_270_5_Tg_hypothalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/270_5_Tg_s4_percentage_of_ions_within_hypothalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_270_5_Tg_hypothalamus_df)[1] = "270_5_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_270_5_Tg_hypothalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_270_5_Tg_hypothalamus_df)

percentage_of_ion_intensities_roi_225_3tg_hypothalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/225_3tg_percentage_of_ions_within_hypothalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_225_3tg_hypothalamus_df)[1] = "225_3tg"
# Make row names into column
percentage_of_ion_intensities_roi_225_3tg_hypothalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_225_3tg_hypothalamus_df)

percentage_of_ion_intensities_roi_270_a1_Tg_hypothalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/270_a1_Tg_s1_percentage_of_ions_within_hypothalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_270_a1_Tg_hypothalamus_df)[1] = "270_a1_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_270_a1_Tg_hypothalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_270_a1_Tg_hypothalamus_df)

percentage_of_ion_intensities_roi_226_a1tg_hypothalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/226_a1tg_percentage_of_ions_within_hypothalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_226_a1tg_hypothalamus_df)[1] = "226_a1tg"
# Make row names into column
percentage_of_ion_intensities_roi_226_a1tg_hypothalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_226_a1tg_hypothalamus_df)

percentage_of_ion_intensities_roi_210_a1tg_hypothalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/210_a1tg_percentage_of_ions_within_hypothalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_210_a1tg_hypothalamus_df)[1] = "210_a1tg"
# Make row names into column
percentage_of_ion_intensities_roi_210_a1tg_hypothalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_210_a1tg_hypothalamus_df)

percentage_of_ion_intensities_roi_249_4_Tg_hypothalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/249_4_Tg_s1_percentage_of_ions_within_hypothalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_249_4_Tg_hypothalamus_df)[1] = "249_4_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_249_4_Tg_hypothalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_249_4_Tg_hypothalamus_df)

percentage_of_ion_intensities_roi_256_a3_Tg_hypothalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/256_a3_Tg_s1_percentage_of_ions_within_hypothalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_256_a3_Tg_hypothalamus_df)[1] = "256_a3_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_256_a3_Tg_hypothalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_256_a3_Tg_hypothalamus_df)

percentage_of_ion_intensities_roi_268_3_Tg_hypothalamus_df <- read.csv('D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/268_3_Tg_s4_percentage_of_ions_within_hypothalamus.csv', row.names = 1)
# Rename column
colnames(percentage_of_ion_intensities_roi_268_3_Tg_hypothalamus_df)[1] = "268_3_Tg"
# Make row names into column
percentage_of_ion_intensities_roi_268_3_Tg_hypothalamus_df$ions <- rownames(percentage_of_ion_intensities_roi_268_3_Tg_hypothalamus_df)
```

Below we combine all the normalized percentage.

```{r}
dfs_to_merge <- list(percentage_of_ion_intensities_roi_226_a2_wt_hypothalamus_df, percentage_of_ion_intensities_roi_225_4wt_hypothalamus_df, percentage_of_ion_intensities_roi_225_a1wt_hypothalamus_df, percentage_of_ion_intensities_roi_208_5wt_hypothalamus_df, percentage_of_ion_intensities_roi_209_2wt_hypothalamus_df, percentage_of_ion_intensities_roi_278_a2_wt_hypothalamus_df, percentage_of_ion_intensities_roi_191_a3wt_hypothalamus_df, percentage_of_ion_intensities_roi_252_8_wt_hypothalamus_df, percentage_of_ion_intensities_roi_268_a3_wt_hypothalamus_df, percentage_of_ion_intensities_roi_225_a2tg_hypothalamus_df, percentage_of_ion_intensities_roi_270_5_Tg_hypothalamus_df, percentage_of_ion_intensities_roi_225_3tg_hypothalamus_df, percentage_of_ion_intensities_roi_270_a1_Tg_hypothalamus_df, percentage_of_ion_intensities_roi_226_a1tg_hypothalamus_df, percentage_of_ion_intensities_roi_210_a1tg_hypothalamus_df, percentage_of_ion_intensities_roi_249_4_Tg_hypothalamus_df, percentage_of_ion_intensities_roi_256_a3_Tg_hypothalamus_df, percentage_of_ion_intensities_roi_268_3_Tg_hypothalamus_df)
# Merge all into one
...
```{r}
processed_SE@metadata$results$`plots_pca.84e8b93b-09c6-4ef2-bfb3-b209f99a4937`

processed_SE@metadata$results$`plots_pca.2a977255-9688-4598-b9a0-9348a9eb77ed`
```
...
```{r}
SE_batches_final_combat@metadata$results$`plots_pca.9d059e96-6729-421d-b43c-f873f0e3bf2f`

SE_batches_final_combat@metadata$results$`plots_pca.5c88b2c8-fc27-4eb9-a4c6-977bfb4da2ab`

SE_batches_final_combat@metadata$results$`plots_pca.714ea8fc-55ab-4000-9b89-fb3a2831897b`
```
...
```{r}
SE_batches_final_median@metadata$results$`plots_pca.107d945c-721f-40a2-9d4a-4415fdfd1002`

SE_batches_final_median@metadata$results$`plots_pca.d92b4c1d-a46a-4296-ba00-1fa35f5749ae`

SE_batches_final_median@metadata$results$`plots_pca.46f1dc6f-6711-494f-97a3-c8283b60aef1`
```
...
```{r}
processed_SE@metadata$results$`plots_pca.16b0f6ae-5559-4295-9ae7-69953e8f2329`

processed_SE@metadata$results$`plots_pca.80635b6a-046f-48b3-a7d0-5c71c050eeff`
```
...
write.csv(assay_not_standardized, "D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/AGE_negative_hypothalamus_combat_batch_corrected_percentages.csv")
...
```{r}
SE_batches_final_combat@metadata$results$`plots_pca.09d4baa9-706f-4edb-9a57-c9088d59a4dd`

SE_batches_final_combat@metadata$results$`plots_pca.41284237-c02b-48cb-8a7a-f2bc1a3ac234`

SE_batches_final_combat@metadata$results$`plots_pca.57ddd1ff-9b2f-432d-a467-43f94397de72`
```
...
#write.csv(median_batch_corrected_data_ions_of_interest, file = "D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/AGE_median_batch_corrected_sums_ions_of_interest.csv")
...
```{r}
SE_batches_final_median@metadata$results$`plots_pca.c8bc7b0a-d1e2-456f-91e8-d2cdaa7a793b`

SE_batches_final_median@metadata$results$`plots_pca.68b49759-931c-452c-a51e-2faa61f3863e`

SE_batches_final_median@metadata$results$`plots_pca.6204459d-3b92-4115-a8b6-5706d8c005a9`
```
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots/6mo_vs_12mo_vs_22mo_significant_all_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots/wt_vs_tg_significant_6mo_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots/wt_vs_tg_significant_with_correction_6mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo[, ion] ~ treatment_final_6mo, main="Ion distribution WT vs Tg 6mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots/wt_vs_tg_significant_12mo_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots/wt_vs_tg_significant_with_correction_12mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo[, ion] ~ treatment_final_12mo, main="Ion distribution WT vs Tg 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots/wt_vs_tg_significant_22mo_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots/wt_vs_tg_significant_with_correction_22mo_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_22mo[, ion] ~ treatment_final_22mo, main="Ion distribution WT vs Tg 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots/6mo_vs_12mo_vs_22mo_significant_wt_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots/6mo_vs_12mo_vs_22mo_significant_with_correction_wt_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots/6mo_vs_12mo_vs_22mo_significant_tg_ANOVA_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots/6mo_vs_12mo_vs_22mo_significant_with_correction_tg_ANOVA_ion_",ion,".png"))
...
write.csv(final_aov_dataframe_with_correction_anova_all, 'D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Average Hypothalamus Statistical Testing Results Normalized By Pixel/AGE_hypothalamus_all_samples_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_6mo_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Average Hypothalamus Statistical Testing Results Normalized By Pixel/AGE_6mo_hypothalamus_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_12mo_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Average Hypothalamus Statistical Testing Results Normalized By Pixel/AGE_12mo_hypothalamus_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_ttest_dataframe_with_correction_22mo_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Average Hypothalamus Statistical Testing Results Normalized By Pixel/AGE_22mo_hypothalamus_wt_vs_tg_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Average Hypothalamus Statistical Testing Results Normalized By Pixel/AGE_hypothalamus_wt_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Average Hypothalamus Statistical Testing Results Normalized By Pixel/AGE_hypothalamus_tg_ANOVA_filtered_ions_statistical_results.csv', row.names=FALSE)
```
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_12mo_wt[, ion] ~ factor(treatment_final_wt_6mo_12mo, levels = c('6mo', '12mo')), main="Ion distribution wt 6mo vs 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_22mo_wt[, ion] ~ factor(treatment_final_wt_6mo_22mo, levels = c('6mo', '22mo')), main="Ion distribution wt 6mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_wt_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_wt_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo_22mo_wt[, ion] ~ factor(treatment_final_wt_12mo_22mo, levels = c('12mo', '22mo')), main="Ion distribution wt 12mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_12mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_12mo_tg[, ion] ~ factor(treatment_final_tg_6mo_12mo, levels = c('6mo', '12mo')), main="Ion distribution tg 6mo vs 12mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots Filtered By Anova Within Phenotype Testing/6mo_vs_22mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_6mo_22mo_tg[, ion] ~ factor(treatment_final_tg_6mo_22mo, levels = c('6mo', '22mo')), main="Ion distribution tg 6mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_tg_only_significant_ttest_ion_",ion,".png"))
...
png(filename=paste("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots Filtered By Anova Within Phenotype Testing/12mo_vs_22mo_tg_only_significant_with_correction_ttest_ion_",ion,".png"))
  boxplot(processed_metabolite_values_combat_final_sample_by_metabolite_12mo_22mo_tg[, ion] ~ factor(treatment_final_tg_12mo_22mo, levels = c('12mo', '22mo')), main="Ion distribution tg 12mo vs 22mo",
   xlab=paste("Ion m/z value", ion), ylab="Z-scored Percentage")
#  get(i) ## may have to print, too:. print(get(I))
  dev.off()
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_12mo_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Average Hypothalamus Statistical Testing Results Within Phenotype Testing/AGE_negative_hypothalamus_6mo_vs_12mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_22mo_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Average Hypothalamus Statistical Testing Results Within Phenotype Testing/AGE_negative_hypothalamus_6mo_vs_22mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_12mo_22mo_wt_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Average Hypothalamus Statistical Testing Results Within Phenotype Testing/AGE_negative_hypothalamus_12mo_vs_22mo_wt_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_12mo_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Average Hypothalamus Statistical Testing Results Within Phenotype Testing/AGE_negative_hypothalamus_6mo_vs_12mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_6mo_22mo_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Average Hypothalamus Statistical Testing Results Within Phenotype Testing/AGE_negative_hypothalamus_6mo_vs_22mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
...
write.csv(final_aov_dataframe_with_correction_anova_12mo_22mo_tg_after_anova, 'D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Average Hypothalamus Statistical Testing Results Within Phenotype Testing/AGE_negative_hypothalamus_12mo_vs_22mo_tg_only_ttest_filtered_ions_statistical_results.csv', row.names=FALSE)
```
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots For Paper/negative_hypothalamus_732_5503_boxplot.tiff", units="in", width=5, height=5, res=300)
...
tiff("D:/NEW All AGE Negative masks and roi sums/Average Hypothalamus/Boxplots For Paper/negative_hypothalamus_871_5392_boxplot.tiff", units="in", width=5, height=5, res=300)
