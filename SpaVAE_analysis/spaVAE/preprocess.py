...
def normalize(adata, filter_min_counts=False, size_factors=False, total_ion_current=True, normalize_input=True, logtrans_input=True):

    if filter_min_counts:
        sc.pp.filter_genes(adata, min_counts=1)

    if size_factors or normalize_input or logtrans_input or total_ion_current:
